...
Section "Common files (Required)" SEC01
  ...
  inetc::get "https://maven.scijava.org/service/local/repositories/sonatype/content/com/fasterxml/jackson/core/jackson-databind/2.12.5/jackson-databind-2.12.5.jar" "$INSTDIR\Fiji.app\jars\jackson-databind-2.12.5.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/sonatype/content/com/fasterxml/jackson/core/jackson-core/2.12.5/jackson-core-2.12.5.jar" "$INSTDIR\Fiji.app\jars\jackson-core-2.12.5.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/sonatype/content/com/fasterxml/jackson/core/jackson-annotations/2.12.5/jackson-annotations-2.12.5.jar" "$INSTDIR\Fiji.app\jars\jackson-annotations-2.12.5.jar"
  ...
  inetc::get "https://maven.scijava.org/service/local/repositories/ome-releases/content/org/openmicroscopy/omero-gateway/5.6.7/omero-gateway-5.6.7.jar" "$INSTDIR\Fiji.app\jars\omero-gateway-5.6.7.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/ome-releases/content/org/openmicroscopy/omero-blitz/5.5.8/omero-blitz-5.5.8.jar" "$INSTDIR\Fiji.app\jars\omero-blitz-5.5.8.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/central/content/com/zeroc/icegrid/3.6.5/icegrid-3.6.5.jar" "$INSTDIR\Fiji.app\jars\icegrid-3.6.5.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/central/content/com/zeroc/glacier2/3.6.5/glacier2-3.6.5.jar" "$INSTDIR\Fiji.app\jars\glacier2-3.6.5.jar"
  ...
  inetc::get "https://maven.scijava.org/service/local/repositories/central/content/org/apache/commons/commons-compress/1.20/commons-compress-1.20.jar" "$INSTDIR\Fiji.app\jars\commons-compress-1.20.jar"
  inetc::get "https://maven.scijava.org/service/local/repositories/central/content/com/fasterxml/jackson/dataformat/jackson-dataformat-yaml/2.12.5/jackson-dataformat-yaml-2.12.5.jar" "$INSTDIR\Fiji.app\jars\jackson-dataformat-yaml-2.12.5.jar"
