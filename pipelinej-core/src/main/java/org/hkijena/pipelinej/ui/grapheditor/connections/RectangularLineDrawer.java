...
package org.hkijena.pipelinej.ui.grapheditor.connections;
...
public class RectangularLineDrawer {
    ...
    public void drawCurrentSegment(Graphics2D graphics2D, ACAQGraphCanvasUI.ViewMode viewMode) {
        Path2D.Float path = new Path2D.Float();
        if (viewMode == ACAQGraphCanvasUI.ViewMode.Horizontal) {
            // A = X, B = Y
        ...
        } else if (viewMode == ACAQGraphCanvasUI.ViewMode.Vertical) {
            // A = Y, B = X
