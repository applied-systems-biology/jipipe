...
import org.hkijena.pipelinej.api.events.CompartmentRemovedEvent;
import org.hkijena.pipelinej.api.events.ExtensionRegisteredEvent;
import org.hkijena.pipelinej.api.grouping.NodeGroup;
import org.hkijena.pipelinej.extensions.settings.GeneralUISettings;
import org.hkijena.pipelinej.extensions.settings.ProjectsSettings;
import org.hkijena.pipelinej.ui.cache.ACAQCacheBrowserUI;
import org.hkijena.pipelinej.ui.cache.ACAQCacheManagerUI;
import org.hkijena.pipelinej.ui.compartments.ACAQCompartmentGraphUI;
import org.hkijena.pipelinej.ui.compartments.ACAQCompartmentUI;
import org.hkijena.pipelinej.ui.compendium.ACAQAlgorithmCompendiumUI;
...
import org.hkijena.pipelinej.ui.extensions.ACAQPluginManagerUIPanel;
import org.hkijena.pipelinej.ui.extensions.ACAQPluginValidityCheckerPanel;
import org.hkijena.pipelinej.ui.running.ACAQRunSettingsUI;
import org.hkijena.pipelinej.ui.running.ACAQRunnerQueueUI;
import org.hkijena.pipelinej.ui.settings.ACAQApplicationSettingsUI;
import org.hkijena.pipelinej.ui.settings.ACAQProjectSettingsUI;
