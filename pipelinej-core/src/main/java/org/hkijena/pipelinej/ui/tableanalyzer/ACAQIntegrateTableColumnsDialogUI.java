...
package org.hkijena.pipelinej.ui.tableanalyzer;

import org.hkijena.pipelinej.api.registries.ACAQTableRegistry;
import org.hkijena.pipelinej.extensions.tables.IntegratingColumnOperation;
import org.hkijena.pipelinej.extensions.tables.ResultsTableData;
import org.hkijena.pipelinej.utils.BusyCursor;
 ...
 */
public class ACAQIntegrateTableColumnsDialogUI extends JDialog {
     ...
     */
    public ACAQIntegrateTableColumnsDialogUI(ResultsTableData inputTableModel) {
    ...
    private void initialize() {
        ...
        for (int columnIndex = 0; columnIndex < inputTableModel.getColumnCount(); ++columnIndex) {
            ...
            for (ACAQTableRegistry.ColumnOperationEntry entry :
                    ACAQTableRegistry.getInstance().getOperationsOfType(IntegratingColumnOperation.class)
    ...
    private static class Renderer extends JLabel implements ListCellRenderer<Object> {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value,
            ...
            if (value instanceof ACAQTableRegistry.ColumnOperationEntry) {
                setText(((ACAQTableRegistry.ColumnOperationEntry) value).getName());
