...
import org.hkijena.pipelinej.api.algorithm.ACAQIteratingAlgorithm;
...
import org.hkijena.pipelinej.extensions.parameters.collections.ListParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.colors.*;
import org.hkijena.pipelinej.extensions.parameters.editors.ACAQAlgorithmDeclarationRefParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.editors.ACAQAlgorithmIconRefParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.editors.ACAQDataDeclarationRefParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.editors.ACAQParameterCollectionVisibilitiesParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.functions.FunctionParameter;
import org.hkijena.pipelinej.extensions.parameters.functions.FunctionParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.functions.StringPatternExtractionFunction;
import org.hkijena.pipelinej.extensions.parameters.generators.*;
import org.hkijena.pipelinej.extensions.parameters.matrix.Matrix2D;
import org.hkijena.pipelinej.extensions.parameters.matrix.Matrix2DFloat;
import org.hkijena.pipelinej.extensions.parameters.matrix.Matrix2DParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.optional.OptionalParameter;
import org.hkijena.pipelinej.extensions.parameters.optional.OptionalParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.pairs.*;
import org.hkijena.pipelinej.extensions.parameters.patterns.StringPatternExtraction;
import org.hkijena.pipelinej.extensions.parameters.patterns.StringPatternExtractionParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.predicates.*;
import org.hkijena.pipelinej.extensions.parameters.primitives.*;
import org.hkijena.pipelinej.extensions.parameters.references.ACAQAlgorithmDeclarationRef;
import org.hkijena.pipelinej.extensions.parameters.references.ACAQAlgorithmIconRef;
import org.hkijena.pipelinej.extensions.parameters.references.ACAQDataDeclarationRef;
import org.hkijena.pipelinej.extensions.parameters.roi.*;
import org.hkijena.pipelinej.extensions.parameters.scripts.ImageJMacro;
import org.hkijena.pipelinej.extensions.parameters.scripts.PythonScript;
import org.hkijena.pipelinej.extensions.parameters.scripts.ScriptParameter;
import org.hkijena.pipelinej.extensions.parameters.scripts.ScriptParameterEditorUI;
import org.hkijena.pipelinej.extensions.parameters.table.ParameterTable;
import org.hkijena.pipelinej.extensions.parameters.table.ParameterTableEditorUI;
import org.hkijena.pipelinej.extensions.parameters.util.ACAQAuthorMetadataParameterEditorUI;
