 ...
 */
public class ScriptParameterEditorUI extends ACAQParameterEditorUI {
     ...
     */
    public ScriptParameterEditorUI(ACAQWorkbench workbench, ACAQParameterAccess parameterAccess) {
