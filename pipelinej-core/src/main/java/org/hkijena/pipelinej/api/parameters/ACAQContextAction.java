...
/**
 * An additional action (usually UI action) that is attached to the {@link org.hkijena.pipelinej.ui.parameters.ParameterPanel}.
 * Annotate a method with this annotation to make it accessible to the UI.
 * Use {@link org.hkijena.pipelinej.api.ACAQDocumentation} to add additional information
 */
