...
public @interface ACAQOrganization {
     ...
     * This is valid for {@link ACAQGraphNode} and {@link org.hkijena.pipelinej.api.data.ACAQData}
     ...
     * This is only valid for algorithm classes that use {@link org.hkijena.pipelinej.api.algorithm.ACAQJavaAlgorithmDeclaration} or any
     * other {@link org.hkijena.pipelinej.api.algorithm.ACAQAlgorithmDeclaration} that listens for algorithm categories.
     *
