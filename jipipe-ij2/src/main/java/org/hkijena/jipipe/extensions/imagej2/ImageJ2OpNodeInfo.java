...
public class ImageJ2OpNodeInfo implements JIPipeNodeInfo {
    ...
    public DefaultJIPipeOutputSlot getOrCreateParameterDataOutputSlot() {
        if (parameterOutputSlot == null) {
            ...
            parameterOutputSlot = new DefaultJIPipeOutputSlot(ParametersData.class, slotName, "Output parameters generated by the IJ2 module", null, true, JIPipeDataSlotRole.Data);
    ...
    public void addInputSlotForModuleItem(ModuleItem<?> item, Class<? extends JIPipeData> dataClass) {
        ...
        inputSlots.add(new DefaultJIPipeInputSlot(dataClass, name, item.getDescription(), true, true, JIPipeDataSlotRole.Data));
    ...
    public void addOutputSlotForModuleItem(ModuleItem<?> item, Class<? extends JIPipeData> dataClass) {
        ...
        outputSlots.add(new DefaultJIPipeOutputSlot(dataClass, name, item.getDescription(), null, true, JIPipeDataSlotRole.Data));
