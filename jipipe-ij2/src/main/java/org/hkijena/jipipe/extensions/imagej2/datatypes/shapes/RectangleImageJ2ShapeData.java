...
public class RectangleImageJ2ShapeData extends ImageJ2ShapeData {
    ...
    public static RectangleImageJ2ShapeData importFrom(Path storagePath, JIPipeProgressInfo progressInfo) {
        return (RectangleImageJ2ShapeData) ImageJ2ShapeData.importFrom(storagePath, progressInfo);
    }
