...
import org.hkijena.jipipe.plugins.parameters.api.optional.JIPipeOptionalParameterContentAccess;
...
//        toggle.setSelected(parameter.isEnabled());
        ...
        JIPipeOptionalParameterContentAccess<?> access = new JIPipeOptionalParameterContentAccess(getParameterAccess(), parameter);
