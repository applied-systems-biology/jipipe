...
@JIPipeDataCrate(
        entities = @JIPipeDataCrateEntity(id = "glob:./*.R", type = JIPipeDataCrateEntityType.File, name = "R script", description = "The R script file", encodingFormat = EncodingFormats.R_SCRIPT)
)
