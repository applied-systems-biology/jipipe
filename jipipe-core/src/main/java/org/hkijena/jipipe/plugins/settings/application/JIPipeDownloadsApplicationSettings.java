...
public class JIPipeDownloadsApplicationSettings extends JIPipeDefaultApplicationsSettingsSheet {
    ...
    private void autoDetectEnvironments() {
        ...
        if (!externalDownloaderProcess.generateValidityReport(new UnspecifiedValidationReportContext(), JIPipeValidationReportSettings.DEFAULT, progressInfo).isValid()) {
...
//                }
    ...
    public static class DownloadEnvironment extends ProcessEnvironment {
        ...
        @AddJIPipeExpressionParameterVariable(name = "Output file", key = "output_file", description = "The downloaded file")
        @AddJIPipeExpressionParameterVariable(name = "URL", key = "url", description = "The URL")
