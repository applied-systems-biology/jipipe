...
public class ResultsTableDataPreview extends JIPipeDesktopAsyncResultDataSlotPreview {
     ...
     */
    public ResultsTableDataPreview(JIPipeDesktopProjectWorkbench workbench, JTable table, JIPipeDataSlot slot, JIPipeDataTableRowInfo row, JIPipeDataAnnotationInfo dataAnnotation) {
