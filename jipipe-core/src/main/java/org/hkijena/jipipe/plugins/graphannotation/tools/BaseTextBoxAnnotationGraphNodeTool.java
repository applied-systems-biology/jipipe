...
public abstract class BaseTextBoxAnnotationGraphNodeTool<T extends DefaultTextBoxAnnotationGraphNode> extends JIPipeAnnotationGraphNodeTool<T> {
    public BaseTextBoxAnnotationGraphNodeTool(Class<T> nodeClass) {
        super(nodeClass);
    }
}
