...
public class JIPipeOptionalParameterContentAccess<T> implements JIPipeParameterAccess {
     ...
     */
    public JIPipeOptionalParameterContentAccess(JIPipeParameterAccess parent, JIPipeOptionalParameter<T> optionalParameter) {
        this.parent = parent;
        this.optionalParameter = optionalParameter;
    }

    public JIPipeOptionalParameter<T> getOptionalParameter() {
