 ...
 */
public class JIPipeEnumParameterTypeInfo implements JIPipeParameterTypeInfo {
     ...
     */
    public JIPipeEnumParameterTypeInfo(String id, Class<? extends Enum<?>> fieldClass, String name, String description) {
        this.id = id;
