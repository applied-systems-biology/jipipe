...
public class ArchiveAssistantCondition extends JIPipeDesktopPublisherAssistantCondition {
    ...
    public ArchiveAssistantCondition(JIPipeDesktopPublisherAssistant assistant) {
        super(assistant);
        initialize();
    }
    ...
    private void showReport() {
        UIUtils.showValidityReportDialog(getDesktopProjectWorkbench(),
                this,
                lastReport,
                "Project archivability report",
                "The following entries are related to the ability to archive the project and its inputs",
                false);
    }
    ...
    public String getAssistantTitle(JIPipeDesktopPublisherAssistantConditionStatus status) {
        return switch (status) {
            case Valid -> "Inputs archivable without issues";
            case Warning -> "Archive may yield non-optimal results";
            case Invalid -> "Inputs cannot be archived";
        };
    }
