 ...
 */
@JsonSerialize(using = JIPipeOptionalParameter.Serializer.class)
@JsonDeserialize(using = JIPipeOptionalParameter.Deserializer.class)
public abstract class JIPipeOptionalParameter<T> implements JIPipeCustomTextDescriptionParameter {
     ...
     */
    public JIPipeOptionalParameter(Class<T> contentClass) {
    ...
    public boolean equals(Object o) {
        ...
        JIPipeOptionalParameter<?> that = (JIPipeOptionalParameter<?>) o;
     ...
     */
    public static class Serializer extends JsonSerializer<JIPipeOptionalParameter<?>> {
        @Override
        public void serialize(JIPipeOptionalParameter<?> objects, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
     ...
     */
    public static class Deserializer<T> extends JsonDeserializer<JIPipeOptionalParameter<T>> implements ContextualDeserializer {

        private JavaType deserializedType;

        @Override
        public JIPipeOptionalParameter<T> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
            JsonNode root = jsonParser.readValueAsTree();

            JIPipeOptionalParameter<T> parameter;
            try {
                parameter = (JIPipeOptionalParameter<T>) deserializedType.getRawClass().newInstance();
            } catch (InstantiationException | IllegalAccessException e) {
                throw new RuntimeException(e);
            }
