...
public class OptionalJIPipeDataDirectoryEnvironment extends OptionalParameter<JIPipeDataDirectoryEnvironment> {
    ...
    public OptionalJIPipeDataDirectoryEnvironment(OptionalJIPipeDataDirectoryEnvironment other) {
        super(other);
        setContent(new JIPipeDataDirectoryEnvironment(other.getContent()));
    }
}
