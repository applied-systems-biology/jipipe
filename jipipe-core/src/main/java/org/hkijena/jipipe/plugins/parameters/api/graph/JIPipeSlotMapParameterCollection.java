 ...
 */
public abstract class JIPipeSlotMapParameterCollection extends JIPipeDynamicParameterCollection implements JIPipeGraphNode.NodeSlotsChangedEventListener {
     ...
     */
    public JIPipeSlotMapParameterCollection(Class<?> dataClass, JIPipeGraphNode node, Function<JIPipeDataSlotInfo, Object> newInstanceGenerator, boolean initialize) {
