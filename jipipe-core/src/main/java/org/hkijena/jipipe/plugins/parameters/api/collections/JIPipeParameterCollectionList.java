 ...
 * We suggest to use this parameter instead of defining custom pairs ({@link JIPipePairParameter} or functions ({@link JIPipeFunctionParameter}
 * <p>
 ...
 */
@JsonSerialize(using = JIPipeParameterCollectionList.Serializer.class)
@JsonDeserialize(using = JIPipeParameterCollectionList.Deserializer.class)
public class JIPipeParameterCollectionList extends JIPipeListParameter<JIPipeDynamicParameterCollection> {

    private JIPipeDynamicParameterCollection template = new JIPipeDynamicParameterCollection(false);

    public JIPipeParameterCollectionList() {
        super(JIPipeDynamicParameterCollection.class);
    }

    public JIPipeParameterCollectionList(JIPipeParameterCollectionList other) {
        super(JIPipeDynamicParameterCollection.class);
     ...
     * @return the list
     */
    public static JIPipeParameterCollectionList containingCollection(Class<? extends JIPipeParameterCollection> klass) {
        JIPipeParameterCollectionList list = new JIPipeParameterCollectionList();
     ...
     * @return the list
     */
    public static JIPipeParameterCollectionList containingSingle(Class<?> klass) {
        JIPipeParameterCollectionList list = new JIPipeParameterCollectionList();
    ...
    public static class Serializer extends JsonSerializer<JIPipeParameterCollectionList> {
        @Override
        public void serialize(JIPipeParameterCollectionList value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
    ...
    public static class Deserializer extends JsonDeserializer<JIPipeParameterCollectionList> {

        @Override
        public JIPipeParameterCollectionList deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode node = p.readValueAsTree();
            JIPipeParameterCollectionList result = new JIPipeParameterCollectionList();
