...
/**
 * Parameter access for one entry in {@link JIPipeListParameter}
 */
public class JIPipeListParameterItemParameterAccess<T> implements JIPipeParameterAccess {
     ...
     */
    public JIPipeListParameterItemParameterAccess(JIPipeParameterAccess parent, List<T> entryList, Class<T> entryType, int index) {
