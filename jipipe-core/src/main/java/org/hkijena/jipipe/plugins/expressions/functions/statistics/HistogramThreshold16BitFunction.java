...
/**
 * Base of 16-bit histogram threshold functions. The histogram must have at most 65536 bins;
 * the bin index is the pixel value.
 */
public abstract class HistogramThreshold16BitFunction extends ExpressionFunction {

    public HistogramThreshold16BitFunction(String name) {
        super(name, 1);
    }
    ...
    public Object evaluate(List<Object> parameters, JIPipeExpressionVariablesMap variables) {
        ...
        return NBinsAutoThresholder.getThreshold16U(getMethod(), histogram);
    }

    @Override
    public ParameterInfo getParameterInfo(int index) {
        return new ParameterInfo("Histogram", "Array of size 65536 containing numbers. The array index " +
