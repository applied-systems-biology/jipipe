...
/**
 * Access to a {@link JIPipeFunctionParameter} output
 *
 * @param <I> input type
 * @param <P> parameter type
 * @param <O> output type
 */
public class JIPipeFunctionParameterOutputAccess<I, P, O> implements JIPipeParameterAccess {

    private final JIPipeParameterAccess parent;
    private final JIPipeFunctionParameter<I, P, O> functionParameter;

    public JIPipeFunctionParameterOutputAccess(JIPipeParameterAccess parent) {
        this.parent = parent;
