 ...
 */
public abstract class JIPipeMatrix2DParameter<T> implements TableModel {
     ...
     */
    public JIPipeMatrix2DParameter(Class<T> entryClass) {
     ...
     */
    public JIPipeMatrix2DParameter(JIPipeMatrix2DParameter<T> other) {
    ...
    public boolean equals(Object o) {
        ...
        JIPipeMatrix2DParameter<?> matrix2D = (JIPipeMatrix2DParameter<?>) o;
     ...
     */
    public static class Serializer extends JsonSerializer<JIPipeMatrix2DParameter<?>> {
        @Override
        public void serialize(JIPipeMatrix2DParameter<?> objects, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
     ...
     */
    public static class Deserializer<T> extends JsonDeserializer<JIPipeMatrix2DParameter<T>> implements ContextualDeserializer {

        private JavaType deserializedType;

        @Override
        public JIPipeMatrix2DParameter<T> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
            JsonNode root = jsonParser.readValueAsTree();

            JIPipeMatrix2DParameter<T> listParameter;
            try {
                listParameter = (JIPipeMatrix2DParameter<T>) deserializedType.getRawClass().newInstance();
