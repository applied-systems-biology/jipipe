...
package org.hkijena.jipipe.desktop.commons.components.validation;
...
public class JIPipeDesktopReloadableValidityChecker extends JIPipeDesktopWorkbenchPanel {
    ...
    public void recheckValidity() {
        report.clear();
        validatable.reportValidity(new UnspecifiedValidationReportContext(), JIPipeValidationReportSettings.DEFAULT, report, new JIPipeProgressInfo());
