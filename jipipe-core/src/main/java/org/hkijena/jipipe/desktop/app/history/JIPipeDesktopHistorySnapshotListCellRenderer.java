 ...
 */
public class JIPipeDesktopHistorySnapshotListCellRenderer extends JPanel implements ListCellRenderer<JIPipeHistoryJournalSnapshot> {
     ...
     */
    public JIPipeDesktopHistorySnapshotListCellRenderer() {
        setOpaque(true);
