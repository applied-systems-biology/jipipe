 ...
 */
public class JIPipeDesktopMinimalDataBatchAssistantDataTableUI extends JIPipeDesktopWorkbenchPanel implements JIPipeParameterCollection.ParameterChangedEventListener {
     ...
     */
    public JIPipeDesktopMinimalDataBatchAssistantDataTableUI(JIPipeDesktopWorkbench workbenchUI, JIPipeDataTable dataTable) {
        super(workbenchUI);
