 ...
 */
public class JIPipeDesktopDataTracerTableModel implements TableModel {
     ...
     */
    public JIPipeDesktopDataTracerTableModel(JTable table, Store<JIPipeDataTable> dataTableStore) {
        this.table = table;
