...
public class JIPipeDesktopCollectTraceRun extends AbstractJIPipeRunnable {
    ...
    public JIPipeDesktopCollectTraceRun(JIPipeDesktopProjectWorkbench workbench, JIPipeGraphNode targetNode, String targetSlotName, UUID targetNodeUUID, JIPipeDataTable targetTable, int targetTableRow) {
