 ...
 */
public class JIPipeDesktopBookmarkedNodeListCellRenderer extends JPanel implements ListCellRenderer<JIPipeGraphNode> {
     ...
     */
    public JIPipeDesktopBookmarkedNodeListCellRenderer() {
        setOpaque(true);
