...
public class JIPipeDesktopBackupManagerPanel extends JIPipeDesktopWorkbenchPanel implements JIPipeRunnable.FinishedEventListener {
    ...
    private void restoreBackup(JIPipeProjectBackupItem backupItem) {
        ...
        Path path = JIPipeDesktop.saveFile(this, getDesktopWorkbench(), JIPipeFileChooserApplicationSettings.LastDirectoryKey.Projects, "Restore backup as ...", HTMLText.EMPTY, PathUtils.EXTENSION_FILTER_JIP);
        if (path != null) {
            try {
