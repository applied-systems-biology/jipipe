...
public class JIPipeDesktopDropShadowRenderer {
    ...
    public JIPipeDesktopDropShadowRenderer() {
        this(Color.BLACK, 5);
    }

    public JIPipeDesktopDropShadowRenderer(Color shadowColor, int shadowSize) {
        this(shadowColor, shadowSize, .5f, 12, false, false, true, true);
    }

    public JIPipeDesktopDropShadowRenderer(boolean showLeftShadow) {
