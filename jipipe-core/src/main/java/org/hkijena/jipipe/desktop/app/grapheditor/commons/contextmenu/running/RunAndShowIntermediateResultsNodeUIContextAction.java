...
public class RunAndShowIntermediateResultsNodeUIContextAction implements NodeUIContextAction {
    ...
    public void runNodes(JIPipeDesktopGraphCanvasUI canvasUI, Set<JIPipeDesktopGraphNodeUI> selection) {
        ...
        ui.getNodeUIActionRequestedEventEmitter().emit(new NodeUIActionRequestedEvent(ui, new JIPipeDesktopRunAndShowResultsAction(true)));
    }
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/rabbitvcs-update.png");
    }
