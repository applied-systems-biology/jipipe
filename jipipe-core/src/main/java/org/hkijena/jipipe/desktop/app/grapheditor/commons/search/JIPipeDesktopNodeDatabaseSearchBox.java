 ...
 */
public class JIPipeDesktopNodeDatabaseSearchBox extends JIPipeDesktopWorkbenchPanel {
     ...
     */
    public JIPipeDesktopNodeDatabaseSearchBox(JIPipeDesktopWorkbench workbench, JIPipeNodeDatabaseRole databaseRole, JIPipeNodeDatabase database) {
        super(workbench);
    ...
    private void initialize() {
        ...
        comboBox.setRenderer(new JIPipeDesktopNodeDatabaseSearchBoxListCellRenderer());
...
//        });
    ...
    public static class SelectedEvent extends AbstractJIPipeEvent {
        private final JIPipeDesktopNodeDatabaseSearchBox searchBox;
        private final JIPipeNodeDatabaseEntry value;

        public SelectedEvent(JIPipeDesktopNodeDatabaseSearchBox searchBox, JIPipeNodeDatabaseEntry value) {
            super(searchBox);
            this.searchBox = searchBox;
            this.value = value;
        }

        public JIPipeDesktopNodeDatabaseSearchBox getSearchBox() {
            return searchBox;
        }
    ...
    private static class RankedDataModel extends AbstractListModel<JIPipeNodeDatabaseEntry> implements ComboBoxModel<JIPipeNodeDatabaseEntry> {
        private final JIPipeDesktopNodeDatabaseSearchBox parent;
        private Object selectedItem;
        private boolean isLoading = false;
        private List<JIPipeNodeDatabaseEntry> rankedEntries = new ArrayList<>();

        public RankedDataModel(JIPipeDesktopNodeDatabaseSearchBox parent) {
            this.parent = parent;
            updateRankedEntries();
        }
