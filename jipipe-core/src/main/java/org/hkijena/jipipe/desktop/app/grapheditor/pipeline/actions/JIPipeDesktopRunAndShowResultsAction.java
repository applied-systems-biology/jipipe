...
package org.hkijena.jipipe.desktop.app.grapheditor.pipeline.actions;

import org.hkijena.jipipe.desktop.app.grapheditor.commons.actions.JIPipeDesktopNodeUIAction;

public class JIPipeDesktopRunAndShowResultsAction implements JIPipeDesktopNodeUIAction {
    private final boolean storeIntermediateResults;

    public JIPipeDesktopRunAndShowResultsAction(boolean storeIntermediateResults) {
