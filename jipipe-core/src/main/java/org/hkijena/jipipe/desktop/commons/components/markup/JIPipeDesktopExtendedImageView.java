 ...
 */
public class JIPipeDesktopExtendedImageView extends View {
    /**
     ...
     */
    public JIPipeDesktopExtendedImageView(Element elem) {
        super(elem);
    ...
    private class ImageHandler implements ImageObserver {
        ...
        public boolean imageUpdate(Image img, int flags, int x, int y,
            ...
            if ((flags & (ABORT | ERROR)) != 0) {
                repaint(0);
                synchronized (JIPipeDesktopExtendedImageView.this) {
                    if (image == img) {
