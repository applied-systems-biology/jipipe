 ...
 */
public class JIPipeDesktopAddParameterDialog extends JIPipeDesktopWorkbenchPanel {
     ...
     */
    public JIPipeDesktopAddParameterDialog(JIPipeDesktopWorkbench workbench, JIPipeDynamicParameterCollection parameterCollection) {
        super(workbench);
     ...
     */
    public static void showDialog(JIPipeDesktopWorkbench workbench, Component parent, JIPipeDynamicParameterCollection parameterCollection) {
        JDialog dialog = new JDialog(SwingUtilities.getWindowAncestor(parent));
        JIPipeDesktopAddParameterDialog panel = new JIPipeDesktopAddParameterDialog(workbench, parameterCollection);
