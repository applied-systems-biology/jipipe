...
public class JIPipeDesktopPipelineQuickGuidePanel extends JIPipeDesktopWorkbenchPanel {
    ...
    private void initialize() {
        ...
        // Adding new nodes
        JIPipeDesktopFormPanel.GroupHeaderPanel addingNewNodesHeader = formPanel.addGroupHeader("Adding new nodes", UIUtils.getIconFromResources("actions/polygon-add-nodes.png"));
