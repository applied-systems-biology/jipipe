 ...
 */
public class JIPipeDesktopDesktopJsonExtensionInfoUI extends JIPipeDesktopJsonExtensionWorkbenchPanel implements JIPipeParameterCollection.ParameterChangedEventListener {
     ...
     */
    public JIPipeDesktopDesktopJsonExtensionInfoUI(JIPipeDesktopJsonExtensionWorkbench workbenchUI) {
        super(workbenchUI);
        initialize();
    ...
    private void initContent() {
        JIPipeDesktopMarkdownReader markdownReader = new JIPipeDesktopMarkdownReader(false, MarkdownText.fromPluginResource("documentation/introduction-extension-builder.md", new HashMap<>()));
        ...
        recentProjectsList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (value != null) {
                        ((JIPipeDesktopJsonExtensionWindow) getExtensionWorkbenchUI().getWindow()).openProject(value);
                    }
                } else {
    ...
    private void initializeHeaderPanel() {
        JPanel headerPanel;
        headerPanel = new JIPipeDesktopImageFrameComponent(UIUtils.getHeaderPanelBackground(), true, SizeFitMode.FitHeight, false);
