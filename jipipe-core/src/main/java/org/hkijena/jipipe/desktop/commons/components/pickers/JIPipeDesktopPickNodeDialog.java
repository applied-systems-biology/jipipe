 ...
 */
public class JIPipeDesktopPickNodeDialog extends JDialog {
     ...
     */
    public JIPipeDesktopPickNodeDialog(Window parent, Set<JIPipeGraphNode> nodes, JIPipeGraphNode preSelected) {
        super(parent);
        this.nodes = nodes;
        initialize();
        reloadNodeList();
    ...
    public static JIPipeGraphNode showDialog(Component parent, Set<JIPipeGraphNode> algorithms, JIPipeGraphNode preSelected, String title) {
        JIPipeDesktopPickNodeDialog dialog = new JIPipeDesktopPickNodeDialog(SwingUtilities.getWindowAncestor(parent), algorithms, preSelected);
    ...
    private void initialize() {
        ...
        nodeJList = new JList<>();
        nodeJList.setCellRenderer(new JIPipeDesktopAlgorithmListCellRenderer());
    ...
    private void initializeButtonPanel() {
        ...
        confirmButton = new JButton("Pick", JIPipe.RESOURCES.getIcon16("actions/color-select.png"));
