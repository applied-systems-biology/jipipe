...
public class JIPipeDesktopDeactivateAndApplyUpdateSiteRun implements JIPipeRunnable {

    private final JIPipeDesktopModernPluginManager pluginManager;
    private final List<UpdateSite> updateSites;
    private JIPipeProgressInfo progressInfo = new JIPipeProgressInfo();

    public JIPipeDesktopDeactivateAndApplyUpdateSiteRun(JIPipeDesktopModernPluginManager pluginManager, List<UpdateSite> updateSites) {
