...
package org.hkijena.jipipe.desktop.commons.components.textfield;
 ...
 */
public class JIPipeDesktopFancyPasswordField extends JPanel {
     ...
     */
    public JIPipeDesktopFancyPasswordField(JLabel icon) {
