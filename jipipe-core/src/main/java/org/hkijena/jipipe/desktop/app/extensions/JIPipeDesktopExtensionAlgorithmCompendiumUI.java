...
public class JIPipeDesktopExtensionAlgorithmCompendiumUI extends JIPipeDesktopAlgorithmCompendiumUI {
    private final JIPipePlugin extension;

    public JIPipeDesktopExtensionAlgorithmCompendiumUI(JIPipePlugin extension) {
