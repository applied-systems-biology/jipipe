 ...
 */
public class JIPipeDesktopExtendedDataTableModel implements TableModel {
     ...
     */
    public JIPipeDesktopExtendedDataTableModel(JTable table, Store<JIPipeDataTable> dataTableStore) {
        this.table = table;
    ...
    public int getColumnCount() {
        JIPipeDataTable dataTable = dataTableStore.get();
        if (dataTable != null) {
            return dataTable.getTextAnnotationColumnNames().size() + dataTable.getDataAnnotationColumnNames().size() + 4;
        } else {
            return 4;
        }
    }
    ...
    private void initializeDeferredPreviewRendering() {
        this.scrollPane.getVerticalScrollBar().addAdjustmentListener(e -> updateRenderedPreviews());
        updateRenderedPreviews();
    }

    public void updateRenderedPreviews() {
        JViewport viewport = scrollPane != null ? scrollPane.getViewport() : null;
