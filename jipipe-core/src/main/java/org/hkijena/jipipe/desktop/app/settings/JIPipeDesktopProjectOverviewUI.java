...
//                                    System.out.println("Found upgrade from " + current.getFullId() + " to " + candidate.getFullId());
    ...
    private void addPanelToCenterPanel(Icon icon, String title, Component center, Component... titleBarComponents) {
        ...
        toolBar.setBackground(ColorUtils.mix(ThemeUtils.getCurrentStyle().getPrimaryColor(), ColorUtils.scaleHSV(UIManager.getColor("Panel.background"), 1, 1, 0.98f), 0.92));
    ...
    private void initialize() {
        ...
        dockPanel.addDockPanel("PARTITIONS",
                "Partitions",
                JIPipe.RESOURCES.getIcon24("actions/runtime-partition.png"),
        ...
        dockPanel.addDockPanel("RUN_SETS",
                "Run sets",
                JIPipe.RESOURCES.getIcon24("actions/debug-run.png"),
                JIPipeDesktopDockPanel.PanelLocation.BottomLeft,
                false,
                0,
                runSetsEditor);
        dockPanel.addDockPanel("BOOKMARKS",
                "Bookmarks",
                JIPipe.RESOURCES.getIcon24("actions/bookmark.png"),
                JIPipeDesktopDockPanel.PanelLocation.BottomLeft,
                false,
                0,
