 ...
 */
public class JIPipeDesktopDataInfoListCellRenderer extends JLabel implements ListCellRenderer<JIPipeDataInfo> {

    /**
     * Creates a new renderer
     */
    public JIPipeDesktopDataInfoListCellRenderer() {
        setOpaque(true);
