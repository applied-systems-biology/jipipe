 ...
 */
public class JIPipeDesktopImageJUpdaterFileTableModel extends AbstractTableModel {
    ...
    public JIPipeDesktopImageJUpdaterFileTableModel(final FilesCollection files) {
        this.files = files;
        updateMappings();
    }
