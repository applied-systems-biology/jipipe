 ...
 */
public class JIPipeDesktopImageJUpdaterProgressAdapter2 implements Progress {
    ...
    public JIPipeDesktopImageJUpdaterProgressAdapter2(JIPipeProgressInfo onProgress) {
