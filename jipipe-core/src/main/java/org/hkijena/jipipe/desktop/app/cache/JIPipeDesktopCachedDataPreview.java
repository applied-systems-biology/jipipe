 ...
 */
public class JIPipeDesktopCachedDataPreview extends JPanel implements JIPipeThumbnailGenerationQueue.ThumbnailGeneratedEventListener {
     ...
     */
    public JIPipeDesktopCachedDataPreview(Component parentComponent, JIPipeDataItemStore data, boolean deferRendering) {
     ...
     * @param deferRendering  if true, the preview will not be immediately rendered
     */
    public JIPipeDesktopCachedDataPreview(Component parentComponent, Store<JIPipeDataItemStore> data, boolean deferRendering) {
        this.parentComponent = parentComponent;
        this.data = data;
        initialize();
        if (!deferRendering) {
