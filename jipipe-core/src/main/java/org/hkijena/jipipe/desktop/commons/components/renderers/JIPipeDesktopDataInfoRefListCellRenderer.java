 ...
 */
public class JIPipeDesktopDataInfoRefListCellRenderer extends JLabel implements ListCellRenderer<JIPipeDataInfoRef> {

    /**
     * Creates a new renderer
     */
    public JIPipeDesktopDataInfoRefListCellRenderer() {
        setOpaque(true);
