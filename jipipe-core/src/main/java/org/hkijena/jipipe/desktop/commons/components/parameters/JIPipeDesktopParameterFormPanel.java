...
public class JIPipeDesktopParameterFormPanel extends JIPipeDesktopFormPanel implements Contextual, Disposable,
    ...
    public static MarkdownText generateParameterDocumentation(JIPipeParameterAccess access, JIPipeParameterTree tree) {
        ...
        if (access.isImportant()) {
            markdownString.append("<tr><td><img src=\"").append(JIPipe.RESOURCES.getIcon16URL("emblems/important.png")).append("\" /></td>");
        ...
        markdownString.append("<tr><td><img src=\"").append(JIPipe.RESOURCES.getIcon16URL("actions/dialog-xml-editor.png")).append("\" /></td>");
        ...
        if (info != null) {
            markdownString.append("<td><img src=\"").append(JIPipe.RESOURCES.getIcon16URL("data-types/data-type.png")).append("\" /></td>");
    ...
    private void addToForm(JIPipeParameterTree tree, JIPipeParameterCollection parameterCollection, List<JIPipeParameterAccess> parameterAccesses, Set<JIPipeParameterAccess> hiddenAccesses) {
        ...
        CustomStateLessToggleButton collapseButton = new CustomStateLessToggleButton("",
        ...
        UIUtils.makeButtonFlat25x25(collapseButton);
        ...
        if (!noGroupHeaders) {
            ...
            if (!noEmptyGroupHeaders || !groupHeaderIsEmpty) {
                ...
                if (isModifiable) {
                    ...
                    groupHeaderPanel.addToEndOfTitlePanel(addButton);
                }
...
//            }
    ...
    private void createGroupHeaderHelpButton(List<JIPipeParameterAccess> parameterAccesses, String headerTitle, SetJIPipeDocumentation documentation, GroupHeaderPanel groupHeaderPanel) {
        ...
        groupHeaderPanel.addToEndOfTitlePanel(helpButton);
    }
