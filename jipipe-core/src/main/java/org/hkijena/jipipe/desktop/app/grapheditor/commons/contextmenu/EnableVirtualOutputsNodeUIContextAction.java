...
public class EnableVirtualOutputsNodeUIContextAction implements GraphInteractiveObjectUIContextAction {
    @Override
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/rabbitvcs-drive.png");
    }
