 ...
 */
public class JIPipeDesktopImageJDataExporterListCellRenderer extends JLabel implements ListCellRenderer<ImageJDataExporter> {

    /**
     * Creates a new renderer
     */
    public JIPipeDesktopImageJDataExporterListCellRenderer() {
        setOpaque(true);
