...
public class JIPipeDesktopDataTracerNodeOutputUI extends JIPipeDesktopProjectWorkbenchPanel implements Disposable {
    ...
    public JIPipeDesktopDataTracerNodeOutputUI(JIPipeDesktopProjectWorkbench workbench, String nodeUUID, String outputSlotName, JIPipeDataTable dataTable, boolean highlighted) {
        super(workbench);
    ...
    private void initialize() {
        ...
        JIPipeDesktopDataTracerDataTableUI tableUI = new JIPipeDesktopDataTracerDataTableUI(getDesktopWorkbench(), new WeakStore<>(dataTable));
    ...
    private void goToNode() {
        ...
        if (node != null) {
            ...
            context.navigate(getDesktopWorkbench());
        } else {
            JOptionPane.showMessageDialog(getDesktopWorkbench().getWindow(), "The node could not be found!", "Go to node", JOptionPane.ERROR_MESSAGE);
        }
    }
