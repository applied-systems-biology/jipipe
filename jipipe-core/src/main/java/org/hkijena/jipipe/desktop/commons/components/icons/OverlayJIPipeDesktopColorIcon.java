 ...
 */
public class OverlayJIPipeDesktopColorIcon implements JIPipeDesktopColorIcon {
    ...
    public OverlayJIPipeDesktopColorIcon(Icon baseIcon, Rectangle insets, boolean drawFill, boolean drawBorder) {
