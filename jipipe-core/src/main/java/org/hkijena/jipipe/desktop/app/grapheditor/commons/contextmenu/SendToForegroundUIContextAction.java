...
public class SendToForegroundUIContextAction implements GraphInteractiveObjectUIContextAction {
    @Override
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/object-order-front.png");
    }
