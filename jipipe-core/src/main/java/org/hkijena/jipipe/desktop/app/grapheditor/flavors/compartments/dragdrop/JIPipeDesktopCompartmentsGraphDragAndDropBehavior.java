 ...
 */
public class JIPipeDesktopCompartmentsGraphDragAndDropBehavior implements JIPipeDesktopGraphDragAndDropBehavior {
        ...
        try {
            ...
            for (int i = 0; i < flavors.length; i++) {
                if (flavors[i].isFlavorTextType()) {
                    ...
                    if(JIPipeDesktopCompartmentsAddCompartmentTransferHandler.VALUE_ADD_COMPARTMENT.equals(text)) {
