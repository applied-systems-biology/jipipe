...
public class InvertSelectionNodeUIContextAction implements GraphInteractiveObjectUIContextAction {
    @Override
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/edit-select-invert.png");
    }
