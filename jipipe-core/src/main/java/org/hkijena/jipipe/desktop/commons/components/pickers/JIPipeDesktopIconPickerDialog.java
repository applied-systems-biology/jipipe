 ...
 */
public class JIPipeDesktopIconPickerDialog extends JDialog implements MouseListener {
     ...
     */
    public JIPipeDesktopIconPickerDialog(Window parent, String prefix, Set<String> availableIcons) {
        super(parent);
        this.prefix = prefix;
    ...
    public static String showDialog(Component parent, String prefix, Set<String> availableIcons) {
        JIPipeDesktopIconPickerDialog dialog = new JIPipeDesktopIconPickerDialog(SwingUtilities.getWindowAncestor(parent),
                prefix,
                availableIcons);
        dialog.pack();
