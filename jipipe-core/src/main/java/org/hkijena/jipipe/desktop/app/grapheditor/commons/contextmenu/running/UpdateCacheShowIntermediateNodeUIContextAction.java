...
package org.hkijena.jipipe.desktop.app.grapheditor.commons.contextmenu.running;
...
public class UpdateCacheShowIntermediateNodeUIContextAction implements NodeUIContextAction {
    ...
    public void runNodes(JIPipeDesktopGraphCanvasUI canvasUI, Set<JIPipeDesktopGraphNodeUI> selection) {
        ...
        ui.getNodeUIActionRequestedEventEmitter().emit(new NodeUIActionRequestedEvent(ui, new JIPipeDesktopUpdateCacheAction(true, false, true)));
    }
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/cache-intermediate-results.png");
    }
