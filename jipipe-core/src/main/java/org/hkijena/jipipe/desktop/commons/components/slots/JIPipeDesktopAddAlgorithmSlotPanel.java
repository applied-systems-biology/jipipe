...
public class JIPipeDesktopAddAlgorithmSlotPanel extends JPanel {
    ...
    private void initialize() {
        ...
        JIPipeDesktopFormPanel.GroupHeaderPanel header = formPanel.addGroupHeader("Add slot to '" + algorithm.getName() + "'", JIPipe.getInstance().getNodes().getIconFor(algorithm.getInfo()));
