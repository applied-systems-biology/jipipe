 ...
 */
public class JIPipeDesktopRecentProjectListCellRenderer extends JPanel implements ListCellRenderer<Path> {
    ...
    public JIPipeDesktopRecentProjectListCellRenderer() {
        setOpaque(true);
        initialize();
