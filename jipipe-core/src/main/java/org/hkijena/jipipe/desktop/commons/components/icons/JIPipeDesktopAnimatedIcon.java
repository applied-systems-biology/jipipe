...
public class JIPipeDesktopAnimatedIcon implements Icon {
    ...
    public JIPipeDesktopAnimatedIcon(Component parent, ImageIcon bottomIcon, ImageIcon topIcon, int delay, double opacityStep) {
        this.parent = parent;
