...
package org.hkijena.jipipe.desktop.commons.components.panels;
...
public class JIPipeDesktopImageFrameComponent extends JPanel {
    ...
    public JIPipeDesktopImageFrameComponent(BufferedImage backgroundImage, boolean withGrid, SizeFitMode mode, boolean center) {
