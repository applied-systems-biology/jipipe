 ...
 */
public class JIPipeDesktopJsonExtensionContentListCellRenderer extends JLabel implements ListCellRenderer<Object> {
    /**
     * Creates a new renderer
     */
    public JIPipeDesktopJsonExtensionContentListCellRenderer() {
        setOpaque(true);
