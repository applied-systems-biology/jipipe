...
public class JIPipeDesktopActivateDependenciesConfirmationDialog extends JDialog {
    ...
    public JIPipeDesktopActivateDependenciesConfirmationDialog(Component parent, JIPipeDesktopModernPluginManager pluginManager, JIPipePlugin extension, Set<JIPipeDependency> missingDependencies, Set<JIPipeImageJUpdateSiteDependency> missingUpdateSites) {
    ...
    private void initializeExtensions(JIPipeDesktopFormPanel formPanel) {
        JIPipeDesktopFormPanel.GroupHeaderPanel groupHeader = formPanel.addGroupHeader("Activated dependencies", UIUtils.getIconFromResources("actions/plugins.png"));
        ...
        for (JIPipeDependency dependency : dependencyExtensionsToActivate) {
            ...
            dependencyPanel.add(UIUtils.createBorderlessReadonlyTextPane(dependency.getMetadata().getDescription().getHtml(), false), new GridBagConstraints(0, 2, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(4, 4, 4, 4), 0, 0));
    ...
    private void initializeUpdateSites(JIPipeDesktopFormPanel formPanel) {
        JIPipeDesktopFormPanel.GroupHeaderPanel groupHeader = formPanel.addGroupHeader("ImageJ update site installation", UIUtils.getIconFromResources("apps/imagej.png"));
        ...
        for (Map.Entry<JIPipeImageJUpdateSiteDependency, Boolean> entry : dependencySitesToInstall.entrySet()) {
            ...
            sitePanel.add(nameLabel, new GridBagConstraints(0,
                    ...
                    0,
                    0));
            JTextPane descriptionLabel = UIUtils.createBorderlessReadonlyTextPane(description, false);
