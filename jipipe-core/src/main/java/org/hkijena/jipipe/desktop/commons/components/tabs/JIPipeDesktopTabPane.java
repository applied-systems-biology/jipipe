 ...
 */
public class JIPipeDesktopTabPane extends JPanel implements Disposable {
    ...
    public static class DocumentTabComponent extends JPanel implements TabRenamedEventListener {
        ...
        private final JIPipeDesktopTabPane documentTabPane;
        private final Icon icon;
        ...
        public DocumentTabComponent(JIPipeDesktopTabPane documentTabPane, Icon icon) {
...
//                setToolTipText(null);
    ...
    public static class DocumentTab extends AbstractJIPipeParameterCollection {
        ...
        private DocumentTab(JIPipeDesktopTabPane documentTabPane, String title, Icon icon, DocumentTabComponent tabComponent, Component content, CloseMode closeMode, JPopupMenu popupMenu) {
            this.documentTabPane = documentTabPane;
            this.title = title;
            this.icon = icon;
    ...
    public static class TabRenamedEvent extends AbstractJIPipeEvent {
        ...
        public TabRenamedEvent(JIPipeDesktopTabPane documentTabPane, DocumentTab tab) {
