...
public class UnlockNodeLocationSizeUIContextAction implements GraphInteractiveObjectUIContextAction {
    @Override
    ...
    @Override
    public Icon getIcon() {
        return JIPipe.RESOURCES.getIcon16("actions/unlock.png");
    }
