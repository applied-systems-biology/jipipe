...
public class JIPipeDesktopImageJUpdaterFileTableModelFilter extends JIPipeDesktopSearchTextFieldTableRowFilter {
     ...
     */
    public JIPipeDesktopImageJUpdaterFileTableModelFilter(JIPipeDesktopSearchTextField searchTextField, ViewOptions.Option option) {
    ...
    public boolean include(Entry<? extends TableModel, ? extends Integer> entry) {
        ...
        JIPipeDesktopImageJUpdaterFileTableModel model = (JIPipeDesktopImageJUpdaterFileTableModel) entry.getModel();
        if (model == null)
            return false;
