...
public class JIPipeDesktopImageJUpdaterUpdateSiteUI extends JPanel {
    private final JIPipeDesktopImageJUpdaterUpdateSiteListUI listUI;
    private final UpdateSite updateSite;

    public JIPipeDesktopImageJUpdaterUpdateSiteUI(JIPipeDesktopImageJUpdaterUpdateSiteListUI listUI, UpdateSite updateSite) {
        this.listUI = listUI;
