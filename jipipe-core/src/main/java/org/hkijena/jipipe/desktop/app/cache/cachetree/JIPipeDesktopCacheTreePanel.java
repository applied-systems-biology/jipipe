 ...
 */
public class JIPipeDesktopCacheTreePanel extends JIPipeDesktopProjectWorkbenchPanel {
     ...
     */
    public JIPipeDesktopCacheTreePanel(JIPipeDesktopProjectWorkbench workbenchUI) {
        super(workbenchUI);
        initialize();
        refreshTree();
    }
