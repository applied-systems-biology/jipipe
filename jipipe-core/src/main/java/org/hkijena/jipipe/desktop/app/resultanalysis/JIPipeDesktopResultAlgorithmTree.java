 ...
 */
public class JIPipeDesktopResultAlgorithmTree extends JIPipeDesktopProjectWorkbenchPanel {
    ...
    public JIPipeDesktopResultAlgorithmTree(JIPipeDesktopProjectWorkbench workbenchUI, JIPipeProject project, Path storagePath) {
        super(workbenchUI);
    ...
    private void initialize() {
        ...
        tree = new JTree();
        tree.setCellRenderer(new JIPipeDesktopResultTreeCellRenderer());
