...
public class JIPipeDesktopExtensionDataTypeCompendiumUI extends JIPipeDataTypeCompendiumUI {
    private final JIPipePlugin extension;

    public JIPipeDesktopExtensionDataTypeCompendiumUI(JIPipePlugin extension) {
