 ...
 */
public class JIPipeDesktopGraphCanvasUIUpdatedEvent extends AbstractJIPipeEvent {
    private final JIPipeDesktopGraphCanvasUI graphCanvasUI;

    public JIPipeDesktopGraphCanvasUIUpdatedEvent(JIPipeDesktopGraphCanvasUI graphCanvasUI) {
        super(graphCanvasUI);
