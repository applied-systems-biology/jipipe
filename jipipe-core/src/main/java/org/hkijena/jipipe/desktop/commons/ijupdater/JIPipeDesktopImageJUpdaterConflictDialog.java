...
/**
 * Copy of {@link JIPipeDesktopImageJUpdaterConflictDialog} because the original one expects an {@link UpdaterFrame}
 */
public abstract class JIPipeDesktopImageJUpdaterConflictDialog extends JDialog implements ActionListener {
    ...
    public JIPipeDesktopImageJUpdaterConflictDialog(Window owner, final String title) {
        super(owner, title);
