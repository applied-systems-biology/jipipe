...
import org.hkijena.jipipe.desktop.commons.components.selection.JIPipeDesktopMultiSelectionModel;
import org.hkijena.jipipe.desktop.commons.components.selection.JIPipeDesktopSingleSelectionModel;
 ...
 */
public class JIPipeDesktopDataTypePicker extends JPanel {
     ...
     */
    public JIPipeDesktopDataTypePicker(Mode mode, Set<JIPipeDataInfo> availableDataTypes) {
        this.mode = mode;
    ...
    public static Set<JIPipeDataInfo> showDialog(Component parent, Mode mode, Set<JIPipeDataInfo> availableDataInfos) {
        ...
        JIPipeDesktopDataTypePicker picker = new JIPipeDesktopDataTypePicker(mode, availableDataInfos);
    ...
    private void initialize() {
        ...
        if (mode == Mode.NonInteractive) {
            ...
            dataTypeList.setSelectionModel(new JIPipeDesktopSingleSelectionModel());
            dataTypeList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        } else {
            dataTypeList.setSelectionModel(new JIPipeDesktopMultiSelectionModel());
    ...
    public static class SelectedDataTypesChangedEvent extends AbstractJIPipeEvent {
        private JIPipeDesktopDataTypePicker dataTypePicker;

        /**
         * @param dataTypePicker event source
         */
        public SelectedDataTypesChangedEvent(JIPipeDesktopDataTypePicker dataTypePicker) {
            super(dataTypePicker);
            this.dataTypePicker = dataTypePicker;
        }

        public JIPipeDesktopDataTypePicker getDataTypePicker() {
    ...
    public static class DataTypeSelectedEvent extends AbstractJIPipeEvent {
         ...
         */
        public DataTypeSelectedEvent(JIPipeDesktopDataTypePicker dataTypePicker, JIPipeDataInfo dataInfo) {
            super(dataTypePicker);
            this.dataTypePicker = dataTypePicker;
    ...
    public static class DataTypeDeselectedEvent extends AbstractJIPipeEvent {
         ...
         */
        public DataTypeDeselectedEvent(JIPipeDesktopDataTypePicker dataTypePicker, JIPipeDataInfo dataInfo) {
            super(dataTypePicker);
            this.dataTypePicker = dataTypePicker;
            this.dataInfo = dataInfo;
        }
