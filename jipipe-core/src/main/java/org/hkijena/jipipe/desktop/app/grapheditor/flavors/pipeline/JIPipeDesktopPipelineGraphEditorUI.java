...
import org.hkijena.jipipe.desktop.app.grapheditor.commons.contextmenu.cache.OpenCacheBrowserInWindowUIContextAction;
import org.hkijena.jipipe.desktop.app.grapheditor.commons.contextmenu.io.*;
...
import org.hkijena.jipipe.desktop.app.grapheditor.flavors.pipeline.properties.JIPipeDesktopPipelineCodePanel;
...
public class JIPipeDesktopPipelineGraphEditorUI extends JIPipeDesktopGraphEditorUI {
    ...
    private void initializeDefaultPanels() {
        ...
        getDockPanel().addDockPanel(DOCK_NODE_TEMPLATES, "Templates",
                JIPipe.RESOURCES.getIcon24("actions/star3.png"),
                JIPipeDesktopDockPanel.PanelLocation.BottomLeft,
                false,
        ...
        getDockPanel().addDockPanel(JIPipeDesktopScriptParameterEditorUI.DOCK_CODE,
                "Code",
                JIPipe.RESOURCES.getIcon24("actions/format-text-code.png"),
                JIPipeDesktopDockPanel.PanelLocation.BottomBottom,
                false,
                0,
                new JIPipeDesktopPipelineCodePanel(this));
//
...
//        }
    ...
    protected void restoreDefaultDockState() {
        ...
        state.put(DOCK_NODE_TEMPLATES, false, JIPipeDesktopDockPanel.PanelLocation.BottomLeft);
