 ...
 */
public class JIPipeDesktopDataSlotListCellRenderer extends JPanel implements ListCellRenderer<JIPipeDataSlot> {
    ...
    public JIPipeDesktopDataSlotListCellRenderer() {
        initialize();
    }
    ...
    private void initialize() {
        ...
        nodeLabel.setFont(new Font(Font.DIALOG, Font.PLAIN, ThemeUtils.getCurrentStyle().getFontSizeSmall()));
