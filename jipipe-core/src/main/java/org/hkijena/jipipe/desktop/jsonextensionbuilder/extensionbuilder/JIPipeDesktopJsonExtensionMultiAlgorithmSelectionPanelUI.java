 ...
 */
public class JIPipeDesktopJsonExtensionMultiAlgorithmSelectionPanelUI extends JIPipeDesktopJsonExtensionWorkbenchPanel {
     ...
     */
    public JIPipeDesktopJsonExtensionMultiAlgorithmSelectionPanelUI(JIPipeDesktopJsonExtensionWorkbench workbenchUI, JIPipeDesktopGraphCanvasUI canvas, Set<JIPipeGraphNode> algorithms) {
        super(workbenchUI);
