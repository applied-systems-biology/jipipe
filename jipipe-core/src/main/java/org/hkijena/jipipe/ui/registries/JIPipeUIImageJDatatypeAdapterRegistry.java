...
/**
 * Registry for {@link org.hkijena.jipipe.api.compat.ImageJDatatypeAdapter} UIs
 */
public class JIPipeUIImageJDatatypeAdapterRegistry {
    ...
    public static JIPipeUIImageJDatatypeAdapterRegistry getInstance() {
        return JIPipeDefaultRegistry.getInstance().getUIImageJDatatypeAdapterRegistry();
    }
}
