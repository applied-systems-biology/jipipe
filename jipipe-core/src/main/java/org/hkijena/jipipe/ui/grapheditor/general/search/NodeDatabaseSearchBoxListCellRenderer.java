...
public class NodeDatabaseSearchBoxListCellRenderer extends JPanel implements ListCellRenderer<JIPipeNodeDatabaseEntry> {
     ...
     */
    public NodeDatabaseSearchBoxListCellRenderer() {
