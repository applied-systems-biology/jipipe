 ...
 */
public class JIPipeJsonExtensionMultiAlgorithmSelectionPanelUI extends JIPipeJsonExtensionWorkbenchPanel {
     ...
     */
    public JIPipeJsonExtensionMultiAlgorithmSelectionPanelUI(JIPipeJsonExtensionWorkbench workbenchUI, JIPipeGraphCanvasUI canvas, Set<JIPipeGraphNode> algorithms) {
        super(workbenchUI);
