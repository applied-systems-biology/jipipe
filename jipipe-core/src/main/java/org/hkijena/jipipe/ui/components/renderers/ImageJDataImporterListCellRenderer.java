 ...
 */
public class ImageJDataImporterListCellRenderer extends JLabel implements ListCellRenderer<ImageJDataImporter> {

    /**
     * Creates a new renderer
     */
    public ImageJDataImporterListCellRenderer() {
        setOpaque(true);
