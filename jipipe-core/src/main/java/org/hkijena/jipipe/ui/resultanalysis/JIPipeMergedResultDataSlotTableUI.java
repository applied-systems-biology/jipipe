...
public class JIPipeMergedResultDataSlotTableUI extends JIPipeProjectWorkbenchPanel implements JIPipeParameterCollection.ParameterChangedEventListener {
    ...
    private final JIPipeLegacyProjectRun run;
     ...
     */
    public JIPipeMergedResultDataSlotTableUI(JIPipeProjectWorkbench workbenchUI, JIPipeLegacyProjectRun run, List<JIPipeDataSlot> slots) {
        super(workbenchUI);
        this.run = run;
        this.slots = slots;
