...
/**
 * Renderer for {@link JIPipeAlgorithmDeclaration}
 */
public class JIPipeAlgorithmDeclarationListCellRenderer extends JLabel implements ListCellRenderer<JIPipeAlgorithmDeclaration> {
     ...
     */
    public JIPipeAlgorithmDeclarationListCellRenderer() {
        setOpaque(true);
        setIcon(icon);
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends JIPipeAlgorithmDeclaration> list, JIPipeAlgorithmDeclaration declaration, int index, boolean isSelected, boolean cellHasFocus) {
