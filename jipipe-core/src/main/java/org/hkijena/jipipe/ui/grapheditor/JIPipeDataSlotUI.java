    ...
    protected void reloadPopupMenu() {
        ...
        if (slot.isInput()) {
            ...
            if(getSlot().isVirtual()) {
                JMenuItem toggleVirtualButton = new JMenuItem("Make non-virtual", UIUtils.getIconFromResources("actions/rabbitvcs-drive.png"));
                ...
                JMenuItem toggleVirtualButton = new JMenuItem("Make virtual", UIUtils.getIconFromResources("actions/rabbitvcs-drive.png"));
                toggleVirtualButton.setToolTipText("Makes that data generated by this slot is stored in a temporary folder if not used during a full analysis. This is slower than memory access and requires disk space on the hard drive. Useful if you have large amounts of data");
