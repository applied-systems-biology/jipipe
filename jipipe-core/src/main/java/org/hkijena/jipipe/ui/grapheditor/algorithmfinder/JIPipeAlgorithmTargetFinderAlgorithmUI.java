...
public class JIPipeAlgorithmTargetFinderAlgorithmUI extends JPanel {
     ...
     */
    public JIPipeAlgorithmTargetFinderAlgorithmUI(JIPipeGraphCanvasUI canvasUI, JIPipeDataSlot outputSlot, JIPipeNodeInfo info) {
     ...
     */
    public JIPipeAlgorithmTargetFinderAlgorithmUI(JIPipeGraphCanvasUI canvasUI, JIPipeDataSlot outputSlot, JIPipeGraphNode algorithm) {
        this.canvasUI = canvasUI;
        this.outputSlot = outputSlot;
