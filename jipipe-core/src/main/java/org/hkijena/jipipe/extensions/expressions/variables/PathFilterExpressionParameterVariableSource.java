...
/**
 * {@link org.hkijena.jipipe.extensions.expressions.ExpressionParameterVariableSource} that defines one variable 'x' that references a filesystem path or file name.
 */
