...
@SetJIPipeDocumentation(name = "Slice Right", description = "Returns a sublist/substring of an array/string/map keys containing all items after (inclusive) an index.")
