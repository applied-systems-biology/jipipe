...
public class NumericOrStringTextInEqualityPredicateOperator extends NumericOrStringPredicateOperator {

    public NumericOrStringTextInEqualityPredicateOperator() {
        super("UNEQUAL");
    }
