 ...
 */
@JIPipeExpressionParameterSettings(variableSource = DataAnnotationQueryExpressionVariablesInfo.class)
...
public class DataAnnotationQueryExpression extends JIPipeExpressionParameter {
