...
/**
 * Parameter for {@link JIPipeDataDeclarationRef}
 */
public class JIPipeDataDeclarationRefParameterEditorUI extends JIPipeParameterEditorUI {
     ...
     */
    public JIPipeDataDeclarationRefParameterEditorUI(JIPipeWorkbench workbench, JIPipeParameterAccess parameterAccess) {
    ...
    public void reload() {
        if (isReloading)
            return;
        isReloading = true;
        JIPipeDataDeclarationRef declarationRef = getParameter(JIPipeDataDeclarationRef.class);
        JIPipeDataDeclaration declaration = declarationRef.getDeclaration();
        if (declaration != null) {
            currentlyDisplayed.setText(declaration.getName());
            currentlyDisplayed.setToolTipText(TooltipUtils.getDataTooltip(declaration));
            currentlyDisplayed.setIcon(JIPipeUIDatatypeRegistry.getInstance().getIconFor(declaration.getDataClass()));
    ...
    private void initializePicker() {
        ...
        Set<JIPipeDataDeclaration> availableTraits = new HashSet<>();
