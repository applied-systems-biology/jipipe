 ...
 */
public class JIPipeGraphHistory {

    private final EventBus eventBus = new EventBus();
    private final Stack<JIPipeAlgorithmGraphHistorySnapshot> snapshots = new Stack<>();
     ...
     */
    public void addSnapshotBefore(JIPipeAlgorithmGraphHistorySnapshot snapshot) {
     ...
     */
    public void removeSnapshot(JIPipeAlgorithmGraphHistorySnapshot snapshot) {
