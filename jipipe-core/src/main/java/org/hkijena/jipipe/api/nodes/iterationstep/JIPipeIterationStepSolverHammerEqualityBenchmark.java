...
public final class JIPipeIterationStepSolverHammerEqualityBenchmark {
    private JIPipeIterationStepSolverHammerEqualityBenchmark() {
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if (flow.size() != comp.size()) {
                System.out.println("Failed at try #" + iteration);
