...
public class GraphAnnotationsNodeTypeCategory implements JIPipeNodeTypeCategory {
    ...
    @Override
    public String getId() {
        return "org.hkijena.jipipe:graph-annotations";
    }
    ...
    public String getDescription() {
        return "Nodes that are used as graph annotations";
    }
