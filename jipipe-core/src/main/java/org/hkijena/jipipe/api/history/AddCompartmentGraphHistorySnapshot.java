...
public class AddCompartmentGraphHistorySnapshot implements JIPipeAlgorithmGraphHistorySnapshot {

    private final JIPipeProject project;
    private final String compartmentName;
    private JIPipeProjectCompartment compartmentInstance;

    public AddCompartmentGraphHistorySnapshot(JIPipeProject project, String compartmentName) {
