...
public enum JIPipeIterationStepSolverPreference {
    Auto("Auto", true, true),
    ...
    JIPipeIterationStepSolverPreference(String label, boolean allowSingleDictionary, boolean allowCompositeDictionary) {
        this.label = label;
