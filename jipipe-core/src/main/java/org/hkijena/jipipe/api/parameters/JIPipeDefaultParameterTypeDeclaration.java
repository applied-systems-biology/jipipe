...
/**
 * Standard implementation of {@link JIPipeParameterTypeDeclaration}
 */
public class JIPipeDefaultParameterTypeDeclaration implements JIPipeParameterTypeDeclaration {
     ...
     */
    public JIPipeDefaultParameterTypeDeclaration(String id, Class<?> fieldClass, Supplier<Object> newInstanceGenerator, Function<Object, Object> duplicateFunction, String name, String description) {
        this.id = id;
