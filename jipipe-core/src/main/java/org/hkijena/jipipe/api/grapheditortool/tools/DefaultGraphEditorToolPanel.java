...
public class DefaultGraphEditorToolPanel extends JIPipeDesktopFormGraphEditorToolPanel<DefaultGraphEditorTool> {
    ...
    public void initializeContent() {
        ...
        getFormPanel().addWideToForm(UIUtils.createLeftAlignedButton("Edit canvas notes", JIPipe.RESOURCES.getIcon16("actions/pencil.png"), () -> {
            getGraphEditorUI().selectToolByClass(EditNotesGraphNodeTool.class);
        }));
    }
}
