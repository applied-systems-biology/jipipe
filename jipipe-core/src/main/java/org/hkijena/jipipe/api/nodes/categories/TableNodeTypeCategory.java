...
public class TableNodeTypeCategory implements JIPipeNodeTypeCategory {
    ...
    public static final Color FILL_COLOR_DARK = Color.getHSBColor(216.0f / 360.0f, 0.5f, 0.3f);
    public static final Color BORDER_COLOR_DARK = Color.getHSBColor(216.0f / 360.0f, 0.5f, 0.9f);
