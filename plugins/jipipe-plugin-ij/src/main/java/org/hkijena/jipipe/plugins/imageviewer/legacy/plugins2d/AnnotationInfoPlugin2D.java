 ...
 */
public class AnnotationInfoPlugin2D extends JIPipeDesktopLegacyImageViewerPlugin2D {
    ...
    public AnnotationInfoPlugin2D(JIPipeDesktopLegacyImageViewer viewerPanel) {
        super(viewerPanel);
