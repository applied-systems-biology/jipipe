...
//    }
    ...
    private void importROIsFromFile() {
        Path path = JIPipeFileChooserApplicationSettings.openFile(getViewerPanel(), getDesktopWorkbench(), JIPipeFileChooserApplicationSettings.LastDirectoryKey.Data, "Import ROI", UIUtils.EXTENSION_FILTER_ROIS);
        if (path != null) {
    ...
    private void exportROIsToFile(ROI2DListData rois) {
        ...
        Path path = JIPipeFileChooserApplicationSettings.saveFile(getViewerPanel(), getDesktopWorkbench(), JIPipeFileChooserApplicationSettings.LastDirectoryKey.Data, "Export ROI", fileNameExtensionFilters);
        if (path != null) {
            rois.save(path);
        }
    }
    ...
    public void buildRibbon(JIPipeDesktopRibbon ribbon) {
        ...
        // Import/Export task
        {
            ...
            importExportBand.add(new JIPipeDesktopLargeButtonRibbonAction("To ROI Manager", "Exports the ROI into the ImageJ ROI manager", UIUtils.getIcon32FromResources("apps/imagej2.png"), this::exportROIsToManager));
    ...
    public Icon getPanelIcon() {
        return UIUtils.getIcon32FromResources("actions/ellipse-5pts.png");
    }
