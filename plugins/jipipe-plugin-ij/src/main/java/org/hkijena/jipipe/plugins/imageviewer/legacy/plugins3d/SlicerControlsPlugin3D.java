...
public class SlicerControlsPlugin3D extends JIPipeDesktopLegacyImageViewerPlugin3D implements JIPipeParameterCollection.ParameterChangedEventListener {

    private final JIPipeDesktopFormPanel orthoSliceEditor = new JIPipeDesktopFormPanel(JIPipeDesktopFormPanel.NONE);

    private final JIPipeDesktopParameterFormPanel multiOrthoSliceEditor;
    ...
    public SlicerControlsPlugin3D(JIPipeDesktopLegacyImageViewer viewerPanel) {
        super(viewerPanel);
