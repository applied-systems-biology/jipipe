...
public class ImageViewer2DCompositeLayerEditor extends JPanel {
    private final JIPipeDesktopLegacyImageViewerPanel2D imageViewerPanel;
    ...
    public ImageViewer2DCompositeLayerEditor(JIPipeDesktopLegacyImageViewerPanel2D imageViewerPanel, int targetChannel) {
...
//        channelLabel.setFont(new Font(Font.DIALOG, Font.BOLD, 12));
        ...
        JIPipeDesktopLegacyImageViewerPanel2D.CompositeLayer layer = imageViewerPanel.getCompositeBlendLayers().getOrDefault(targetChannel, null);
        if (layer != null) {
