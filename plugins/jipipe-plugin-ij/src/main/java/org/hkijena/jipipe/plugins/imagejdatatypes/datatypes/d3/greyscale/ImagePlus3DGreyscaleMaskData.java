 ...
 * 8-bit mask 3D image
 */
@SetJIPipeDocumentation(name = "3D ImageJ image (mask)", description = "An 8-bit binary image")
...
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus3DGreyscale8UData.class)
