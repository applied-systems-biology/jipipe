 ...
 * RGB color 5D image
 */
@SetJIPipeDocumentation(name = "5D ImageJ image (LAB)", description = "A color image (LAB colors)")
...
public class ImagePlus5DColorLABData extends ImagePlus5DColorData {
     ...
     */
    public ImagePlus5DColorLABData(ImageDimensions dimensions) {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus5DColorLABData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
