...
public class RenderSettingsPlugin3D extends JIPipeDesktopLegacyImageViewerPlugin3D {
    public RenderSettingsPlugin3D(JIPipeDesktopLegacyImageViewer viewerPanel) {
        super(viewerPanel);
    }
