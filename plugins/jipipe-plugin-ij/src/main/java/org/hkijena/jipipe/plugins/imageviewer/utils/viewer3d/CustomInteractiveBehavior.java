...
public class CustomInteractiveBehavior extends InteractiveBehavior {
    ...
    private final CustomImage3DUniverse customUniverse;

    private long kineticZoomLastTick;

    public CustomInteractiveBehavior(CustomImage3DUniverse customUniverse) {
        super(customUniverse);
        this.customUniverse = customUniverse;
    }
    ...
    protected void doProcess(MouseEvent e) {
        ...
        CustomInteractiveViewPlatformTransformer viewTransformer = customUniverse.getCustomInteractiveViewPlatformTransformer();
