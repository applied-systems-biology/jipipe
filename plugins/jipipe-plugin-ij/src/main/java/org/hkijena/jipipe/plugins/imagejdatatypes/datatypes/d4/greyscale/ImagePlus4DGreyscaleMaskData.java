 ...
 * Mask 4D image
 */
@SetJIPipeDocumentation(name = "4D ImageJ image (mask)", description = "An 8-bit binary image")
...
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus4DGreyscaleData.class)
