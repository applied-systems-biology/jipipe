 ...
 */
public class ImageViewer2DUIApplicationSettings extends JIPipeDefaultApplicationsSettingsSheet {
    ...
    public static ImageViewer2DUIApplicationSettings getInstance() {
        return JIPipe.getSettings().getById(ID, ImageViewer2DUIApplicationSettings.class);
    }
