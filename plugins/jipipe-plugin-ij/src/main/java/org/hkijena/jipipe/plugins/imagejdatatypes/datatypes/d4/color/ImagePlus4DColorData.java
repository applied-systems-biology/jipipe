...
package org.hkijena.jipipe.plugins.imagejdatatypes.datatypes.d4.color;
 ...
 */
@SetJIPipeDocumentation(name = "4D ImageJ Image (Color)", description = "A color image")
...
public class ImagePlus4DColorData extends ImagePlus4DData implements ColorImageData {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus4DColorData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        ...
        if (image.getType() != ImagePlus.COLOR_RGB) {
            ...
            return new ImagePlus4DColorData(image, data.getColorSpace());
        }
    }
