 ...
 */
@SetJIPipeDocumentation(name = "5D ImageJ image (16 bit)", description = "A 16-bit greyscale image")
@ConfigureJIPipeNode(menuPath = "Images\n5D\nGreyscale")
@LabelAsJIPipeHeavyData
@ImageTypeInfo(imageProcessorType = ShortProcessor.class, colorSpace = GreyscaleColorSpace.class, pixelType = Short.class, bitDepth = 16, numDimensions = 5)
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus5DGreyscaleData.class)
public class ImagePlus5DGreyscale16UData extends ImagePlus5DGreyscaleData {
     ...
     */
    public ImagePlus5DGreyscale16UData(ImageDimensions dimensions) {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus5DGreyscale16UData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
