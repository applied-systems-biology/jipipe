...
public abstract class JIPipeDesktopLegacyImageViewerPlugin3D extends JIPipeDesktopLegacyImageViewerPlugin {

    public JIPipeDesktopLegacyImageViewerPlugin3D(JIPipeDesktopLegacyImageViewer viewerPanel) {
        super(viewerPanel);
    }

    public JIPipeDesktopLegacyImageViewerPanel3D getViewerPanel3D() {
