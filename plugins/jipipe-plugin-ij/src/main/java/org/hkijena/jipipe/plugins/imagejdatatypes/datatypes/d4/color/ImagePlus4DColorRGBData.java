 ...
 * RGB color 4D image
 */
@SetJIPipeDocumentation(name = "4D ImageJ image (RGB)", description = "A color image (RGB colors)")
...
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus4DColorData.class)
