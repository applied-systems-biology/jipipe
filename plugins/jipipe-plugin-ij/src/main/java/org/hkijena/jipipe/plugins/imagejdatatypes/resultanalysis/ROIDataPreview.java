...
public class ROIDataPreview extends JIPipeDesktopAsyncResultDataSlotPreview {
     ...
     */
    public ROIDataPreview(JIPipeDesktopProjectWorkbench workbench, JTable table, JIPipeDataSlot slot, JIPipeDataTableRowInfo row, JIPipeDataAnnotationInfo dataAnnotation) {
