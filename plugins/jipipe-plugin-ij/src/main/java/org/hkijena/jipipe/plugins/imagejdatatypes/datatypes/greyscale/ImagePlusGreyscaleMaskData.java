 ...
 */
@SetJIPipeDocumentation(name = "ImageJ Image (mask)", description = "An 8-bit binary image")
...
public class ImagePlusGreyscaleMaskData extends ImagePlusGreyscale8UData {
     ...
     */
    public ImagePlusGreyscaleMaskData(ImageDimensions dimensions) {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlusGreyscaleMaskData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
