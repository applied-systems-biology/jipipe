 ...
 */
public class LegacyImageViewer3DUIApplicationSettings extends JIPipeDefaultApplicationsSettingsSheet {
    ...
    public static LegacyImageViewer3DUIApplicationSettings getInstance() {
        return JIPipe.getSettings().getById(ID, LegacyImageViewer3DUIApplicationSettings.class);
    }
