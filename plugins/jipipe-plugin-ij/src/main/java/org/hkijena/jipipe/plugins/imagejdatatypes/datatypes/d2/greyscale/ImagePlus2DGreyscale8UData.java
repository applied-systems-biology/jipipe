 ...
 */
@SetJIPipeDocumentation(name = "2D ImageJ image (8 bit)", description = "An 8-bit greyscale image")
...
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus2DGreyscaleData.class)
