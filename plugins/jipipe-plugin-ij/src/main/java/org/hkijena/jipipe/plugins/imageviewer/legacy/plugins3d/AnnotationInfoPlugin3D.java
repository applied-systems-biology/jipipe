 ...
 */
public class AnnotationInfoPlugin3D extends JIPipeDesktopLegacyImageViewerPlugin3D {
    ...
    public AnnotationInfoPlugin3D(JIPipeDesktopLegacyImageViewer viewerPanel) {
        super(viewerPanel);
