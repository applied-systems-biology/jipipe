 ...
 * RGB color 5D image
 */
@SetJIPipeDocumentation(name = "5D ImageJ image (HSB)", description = "A color image (HSB colors)")
@ConfigureJIPipeNode(menuPath = "Images\n5D\nColor")
@LabelAsJIPipeHeavyData
@ImageTypeInfo(imageProcessorType = ColorProcessor.class, colorSpace = HSBColorSpace.class, pixelType = Integer.class, bitDepth = 24, numDimensions = 5)
@ConfigureJIPipeDataCrate(entities = {}, inherits = ImagePlus5DColorData.class)
public class ImagePlus5DColorHSBData extends ImagePlus5DColorData {
    ...
    public ImagePlus5DColorHSBData(ImagePlus image, ColorSpace ignored) {
        super(ImageJUtils.convertToColorHSBIfNeeded(image));
    }
     ...
     */
    public ImagePlus5DColorHSBData(ImageDimensions dimensions) {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus5DColorHSBData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
