 ...
 */
@SetJIPipeDocumentation(name = "2D ImageJ image (16 bit)", description = "A 16-bit greyscale image")
...
public class ImagePlus2DGreyscale16UData extends ImagePlus2DGreyscaleData {
     ...
     */
    public ImagePlus2DGreyscale16UData(ImageDimensions dimensions) {
    ...
    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus2DGreyscale16UData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
