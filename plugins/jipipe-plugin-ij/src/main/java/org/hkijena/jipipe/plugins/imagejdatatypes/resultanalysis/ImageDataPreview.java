...
public class ImageDataPreview extends JIPipeDesktopAsyncResultDataSlotPreview {
     ...
     */
    public ImageDataPreview(JIPipeDesktopProjectWorkbench workbench, JTable table, JIPipeDataSlot slot, JIPipeDataTableRowInfo row, JIPipeDataAnnotationInfo dataAnnotation) {
