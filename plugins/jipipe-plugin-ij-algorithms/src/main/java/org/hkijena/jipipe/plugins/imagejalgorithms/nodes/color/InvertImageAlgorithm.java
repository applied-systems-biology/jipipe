 ...
 */
@SetJIPipeDocumentation(name = "Invert pixel colors/values", description = "Inverts the colors/values p of an image. With 8-bit images, p=255-p.\n" +
...
public class InvertImageAlgorithm extends JIPipeSimpleIteratingAlgorithm {
     ...
     * @param info the info
     */
    public InvertImageAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }
     ...
     */
    public InvertImageAlgorithm(InvertImageAlgorithm other) {
        super(other);
    }
