...
public class GlobalLinesHoughDetection2DAlgorithm extends JIPipeSimpleIteratingAlgorithm {
    ...
    private OptionalJIPipeExpressionParameter houghArrayNMSNeighborhoodSize = new OptionalJIPipeExpressionParameter(false, "ARRAY(MAX(3, ROUND_ODD(H.width / 50)), MAX(3, ROUND_ODD(H.height / 50)))");
