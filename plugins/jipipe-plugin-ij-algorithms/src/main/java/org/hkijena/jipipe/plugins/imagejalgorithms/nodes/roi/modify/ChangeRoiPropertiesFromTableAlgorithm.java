...
public class ChangeRoiPropertiesFromTableAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    public ChangeRoiPropertiesFromTableAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public ChangeRoiPropertiesFromTableAlgorithm(ChangeRoiPropertiesFromTableAlgorithm other) {
        super(other);
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        for (int roiIndex = 0; roiIndex < inputRois.size(); roiIndex++) {
            ...
            boolean found = false;
            for (int row = 0; row < inputMetadata.getRowCount(); row++) {
