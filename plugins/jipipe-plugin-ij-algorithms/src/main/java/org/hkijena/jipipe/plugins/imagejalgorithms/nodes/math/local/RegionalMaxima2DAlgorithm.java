...
@SetJIPipeDocumentation(name = "Regional maxima 2D", description = "Returns the regions that have a constant intensity value and are surrounded by lower intensity values. " +
