...
@SetJIPipeDocumentation(name = "Draw/modify mask (interactive)", description = "Allows users to draw or modify a mask that is drawn over a reference image." +
...
@MarkNodeAsUnstable
public class InteractiveDrawMaskAlgorithm extends JIPipeIteratingMissingDataGeneratorAlgorithm {
    ...
    public InteractiveDrawMaskAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public InteractiveDrawMaskAlgorithm(InteractiveDrawMaskAlgorithm other) {
        super(other);
