...
import org.hkijena.jipipe.plugins.imagejalgorithms.parameters.OverlapStatistics;
import org.hkijena.jipipe.plugins.imagejalgorithms.parameters.OverlapStatisticsSetParameter;
...
@AddJIPipeOutputSlot(value = ResultsTableData.class, name = "Total", create = true)
@AddJIPipeOutputSlot(value = ResultsTableData.class, name = "Per label", create = true)
