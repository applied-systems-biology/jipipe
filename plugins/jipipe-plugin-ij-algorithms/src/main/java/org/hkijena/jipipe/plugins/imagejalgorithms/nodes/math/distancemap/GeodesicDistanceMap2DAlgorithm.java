...
@AddJIPipeInputSlot(value = ImagePlusGreyscaleMaskData.class, name = "Marker", create = true)
...
public class GeodesicDistanceMap2DAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        ImageJIterationUtils.forEachIndexedZCTSlice(markerImage, (ipMarker, index) -> {
