 ...
 */
@SetJIPipeDocumentation(name = "Filter & merge 2D ROI by statistics (Script)", description = "Executes a script that has full control over the input ROI lists. The Python script contains a variable 'row_lists' " +
