...
public class FilterRoi2dByOverlapAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    public FilterRoi2dByOverlapAlgorithm(FilterRoi2dByOverlapAlgorithm other) {
        super(other);
    ...
    private boolean isZCTVisible(Roi roi1, Roi roi2) {
    ...
    @AddJIPipeExpressionParameterVariable(fromClass = RoiOverlapStatisticsVariablesInfo.class)
