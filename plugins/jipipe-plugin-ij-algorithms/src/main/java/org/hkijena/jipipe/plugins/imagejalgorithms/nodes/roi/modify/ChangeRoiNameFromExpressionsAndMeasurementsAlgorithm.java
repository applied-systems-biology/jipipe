...
public class ChangeRoiNameFromExpressionsAndMeasurementsAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    @SetJIPipeDocumentation(name = "Measurements", description = "Measurements to be included. Please open the expression builder to see the variables generated by the measurements." + "<br/><br/>" + ImageJMeasurementsSetParameter.ALL_DESCRIPTIONS)
