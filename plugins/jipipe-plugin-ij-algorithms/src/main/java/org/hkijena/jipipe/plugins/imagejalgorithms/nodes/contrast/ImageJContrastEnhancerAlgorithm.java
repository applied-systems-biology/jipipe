...
@AddJIPipeNodeAlias(nodeTypeCategory = ImageJNodeTypeCategory.class, menuPath = "Process", aliasName = "Brightness/Contrast... (per slice, apply)")
public class ImageJContrastEnhancerAlgorithm extends JIPipeSimpleIteratingAlgorithm {
    ...
    public ImageJContrastEnhancerAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public ImageJContrastEnhancerAlgorithm(ImageJContrastEnhancerAlgorithm other) {
        super(other);
