 ...
 */
@SetJIPipeDocumentation(name = "Local auto threshold 2D (Sauvola, 16-bit)", description = "Applies a local auto-thresholding algorithm. " +
...
public class SauvolaLocalAutoThreshold2D16UAlgorithm extends JIPipeSimpleIteratingAlgorithm {
    private boolean darkBackground = true;
    private double k = 0.5;
    private double r = 32768;
    private int radius = 15;

    /**
     * @param info the info
     */
    public SauvolaLocalAutoThreshold2D16UAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }
     ...
     */
    public SauvolaLocalAutoThreshold2D16UAlgorithm(SauvolaLocalAutoThreshold2D16UAlgorithm other) {
        super(other);
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        ImageJIterationUtils.forEachIndexedZCTSlice(img, (processor, index) -> {
            ...
            LocalAutoThreshold16UUtils.Sauvola(processor, radius, k, r, true, out);
    ...
    @SetJIPipeDocumentation(name = "R", description = "Value of the parameter 'r' in the threshold formula (see Sauvola et al., 2000). For 16-bit images, this should be half the dynamic range; a recommended value is 32768.")
    @JIPipeParameter("r")
    public double getR() {
        return r;
    }
