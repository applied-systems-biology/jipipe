...
public class TablesPlugin extends JIPipePrepackagedDefaultJavaPlugin {
    ...
    private void registerAlgorithms() {
        registerNodeType("table-add-columns-generate", GenerateColumnAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/edit-table-insert-column-right.png"));
        registerNodeType("table-remove-columns", RemoveColumnAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/edit-table-delete-column.png"));
        registerNodeType("table-rename-columns", RenameTableColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/document-edit.png"));
        registerNodeType("table-rename-columns-2", RenameTableColumns2Algorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/document-edit.png"));
        registerNodeType("table-rename-columns-to-annotation", RenameTableColumnsToAnnotationAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/document-edit.png"));
        registerNodeType("table-rename-single-columns", RenameSingleColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/document-edit.png"));
        registerNodeType("table-integrate-columns", IntegrateColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-convert-columns", ConvertColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/formula.png"));
        registerNodeType("table-apply-expression-per-row", ApplyExpressionPerRowAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-apply-expression-per-row-v2", ApplyExpressionPerRowAlgorithm2.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-split-into-columns", SplitTableIntoColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/split.png"));
        registerNodeType("table-split-into-rows", SplitTableIntoRowsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/split.png"));
        registerNodeType("table-merge-from-columns", MergeColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/merge.png"));
        registerNodeType("table-merge-tables", MergeTableRowsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/merge.png"));
        registerNodeType("table-merge-columns-supplement", MergeTableColumnsSupplementAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/merge.png"));
        registerNodeType("table-merge-columns-supplement-merge", MergeTableColumnsSupplementMergingAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/merge.png"));
        registerNodeType("table-split-by-columns", SplitTableByColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/split.png"));
        registerNodeType("table-filter", FilterTableRowsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/filter.png"));
        registerNodeType("table-filter-2", FilterTablesAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/filter.png"));
        registerNodeType("table-slice-rows", SliceTableRowsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/filter.png"));
        registerNodeType("table-sort", SortTableRowsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/view-sort.png"));
        registerNodeType("table-sort-columns", SortTableColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/view-sort.png"));
        registerNodeType("table-add-annotation-columns", AddAnnotationColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/edit-table-insert-column-right.png"));
        registerNodeType("convert-annotation-table-to-annotated-tables", ConvertAnnotationTableToAnnotatedTables.class, JIPipe.RESOURCES.getIcon16URL("data-types/annotation-table.png"));
        registerNodeType("modify-tables", ModifyTablesScript.class, JIPipe.RESOURCES.getIcon16URL("apps/python.png"));
        registerNodeType("modify-and-merge-tables", ModifyAndMergeTablesScript.class, JIPipe.RESOURCES.getIcon16URL("apps/python.png"));
        registerNodeType("tables-from-script", TablesFromScript.class, JIPipe.RESOURCES.getIcon16URL("apps/python.png"));
        registerNodeType("tables-from-expression", GenerateTableFromExpressionAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("define-tables", DefineTablesAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("data-types/results-table.png"));
        registerNodeType("table-rename-columns-expression", ModifyTableColumnNamesAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/document-edit.png"));
        registerNodeType("table-merge-columns", MergeTableColumnsSimpleAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/merge.png"));
        registerNodeType("table-annotate-by-merged-columns", ColumnsToAnnotationsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("data-types/results-table.png"));
        registerNodeType("annotate-data-with-table-values", AnnotateDataWithTableValues.class, JIPipe.RESOURCES.getIcon16URL("data-types/results-table.png"));
        registerNodeType("table-column-to-string", ColumnToStringAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-column-to-numeric", ColumnToNumericAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-process-columns", ApplyExpressionToColumnsAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-apply-expression-to-table-by-columns", ApplyExpressionToTableByColumnAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-melt", MeltTableAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-unmelt", UnMeltTableAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/insert-math-expression.png"));
        registerNodeType("table-annotate-with-properties", AnnotateByTablePropertiesAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/tag.png"));
        registerNodeType("table-add-missing-rows-in-series", AddMissingRowsInSeriesAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/view-sort-ascending.png"));
        registerNodeType("table-convert-to-histogram-key-value", ApplyExpressionPerLabelAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-convert-to-histogram", TableToHistogramAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-convert-to-histogram-2", TableToHistogram2Algorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-convert-to-count-column-value-occurrences", TableColumnToCountAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-rows-kmeans-clustering", KMeansClusteringAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-rows-dbscan-clustering", DBSCANClusteringAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
        registerNodeType("table-rows-fuzzy-kmeans-clustering", FuzzyKMeansClusteringAlgorithm.class, JIPipe.RESOURCES.getIcon16URL("actions/statistics.png"));
