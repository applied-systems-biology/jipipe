...
@ConfigureJIPipeDataCrate(humanReadableDescription = "Contains a JSON file that stores the properties of the spot detector", jsonSchemaURL = "https://jipipe.org/schemas/datatypes/jipipe-json-data.schema.json")
