...
import org.hkijena.jipipe.plugins.parameters.library.references.OptionalDataInfoRefParameter;
...
public class MultiTemplateMatchingAlgorithm extends JIPipeMergingAlgorithm {
    ...
    @RegisterJIPipeParameterCollectionContextAction(icon = "actions/draw-use-tilt.png")
