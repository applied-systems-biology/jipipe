...
@SetJIPipeDocumentation(name = "Extended maxima 3D", description = "Returns the extended minima.")
...
@AddJIPipeNodeAlias(nodeTypeCategory = ImageJNodeTypeCategory.class, menuPath = "Plugins\nMorphoLibJ\nMinima and Maxima", aliasName = "Extended Max (3D)")
public class ExtendedMaxima3DAlgorithm extends JIPipeSimpleIteratingAlgorithm {
     ...
     * @param info the info
     */
    public ExtendedMaxima3DAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }
     ...
     */
    public ExtendedMaxima3DAlgorithm(ExtendedMaxima3DAlgorithm other) {
        super(other);
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        ImageStack resultStack = MinimaAndMaxima3D.extendedMaxima(inputImage.getStack(), dynamic, connectivity.getNativeValue());
