...
public class ImageJAlgorithmsPlugin extends JIPipePrepackagedDefaultJavaPlugin {
    ...
    public static final JIPipeResourceManager RESOURCES = new JIPipeResourceManager(ImageJAlgorithmsPlugin.class, "org/hkijena/jipipe/extensions/imagejalgorithms");
