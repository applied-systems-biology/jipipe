...
@AddJIPipeNodeAlias(nodeTypeCategory = ImageJNodeTypeCategory.class, menuPath = "Plugins\nMorphoLibJ\nMinima and Maxima", aliasName = "Regional Max 3D")
public class RegionalMaxima3DAlgorithm extends JIPipeSimpleIteratingAlgorithm {
     ...
     * @param info the info
     */
    public RegionalMaxima3DAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }
     ...
     */
    public RegionalMaxima3DAlgorithm(RegionalMaxima3DAlgorithm other) {
        super(other);
