...
@SetJIPipeDocumentation(name = "Import R script", description = "Imports a R script from a file")
...
public class ImportRScriptAlgorithm extends JIPipeSimpleIteratingAlgorithm {
    public ImportRScriptAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public ImportRScriptAlgorithm(ImportRScriptAlgorithm other) {
        super(other);
    }
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        try {
            ...
            iterationStep.addOutputData(getFirstOutputSlot(), new RScriptData(text), progressInfo);
        } catch (IOException e) {
