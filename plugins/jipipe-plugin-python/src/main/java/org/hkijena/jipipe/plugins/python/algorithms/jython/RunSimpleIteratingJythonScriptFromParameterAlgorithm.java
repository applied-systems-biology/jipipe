...
public class RunSimpleIteratingJythonScriptFromParameterAlgorithm extends JIPipeSimpleIteratingAlgorithm implements JIPipeScriptAlgorithm {
     ...
     * @param info the info
     */
    public RunSimpleIteratingJythonScriptFromParameterAlgorithm(JIPipeNodeInfo info) {
     ...
     */
    public RunSimpleIteratingJythonScriptFromParameterAlgorithm(RunSimpleIteratingJythonScriptFromParameterAlgorithm other) {
        super(other);
