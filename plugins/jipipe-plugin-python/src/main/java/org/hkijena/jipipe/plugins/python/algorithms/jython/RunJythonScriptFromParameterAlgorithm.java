 ...
 */
@SetJIPipeDocumentation(name = "Run Jython script (parameter, custom)", description = "Runs a Python script that has direct access to all input data slots. " +
...
public class RunJythonScriptFromParameterAlgorithm extends JIPipeParameterSlotAlgorithm implements JIPipeScriptAlgorithm {
     ...
     * @param info the info
     */
    public RunJythonScriptFromParameterAlgorithm(JIPipeNodeInfo info) {
     ...
     */
    public RunJythonScriptFromParameterAlgorithm(RunJythonScriptFromParameterAlgorithm other) {
        super(other);
