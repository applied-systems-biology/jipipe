 ...
 */
@SetJIPipeDocumentation(name = "Run Python script (parameter, iterating)", description = "Runs a Python script that iterates through each iteration step in the input slots. " +
