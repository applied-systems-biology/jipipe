...
public class AllFilamentEdgeVariablesInfo implements JIPipeExpressionVariablesInfo {

    public static final Set<JIPipeExpressionParameterVariableInfo> VARIABLES;

    static {
        VARIABLES = new HashSet<>();
        for (JIPipeExpressionParameterVariableInfo variable : FilamentEdgeVariablesInfo.VARIABLES) {
