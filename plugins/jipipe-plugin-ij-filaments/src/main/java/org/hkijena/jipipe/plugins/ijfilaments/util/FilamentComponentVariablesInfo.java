...
public class FilamentComponentVariablesInfo implements JIPipeExpressionVariablesInfo {
    ...
    static {
        ...
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMinX", "Min X (center, pixels)", "Minimum center X (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMinY", "Min Y (center, pixels)", "Minimum center Y (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMinZ", "Min Z (center, pixels)", "Minimum center Z (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMaxX", "Max X (center, pixels)", "Maximum center X (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMaxY", "Max Y (center, pixels)", "Maximum center Y (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centerMaxZ", "Max Z (center, pixels)", "Maximum center Z (in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMinX", "Min X (sphere, pixels)", "Minimum X (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMinY", "Min Y (sphere, pixels)", "Minimum Y (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMinZ", "Min Z (sphere, pixels)", "Minimum Z (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMaxX", "Max X (sphere, pixels)", "Maximum X (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMaxY", "Max Y (sphere, pixels)", "Maximum Y (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("sphereMaxZ", "Max Z (sphere, pixels)", "Maximum Z (sphere around the center, in pixels). Per vertex."));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centroidX", "Centroid X (pixels)", "Centroid X (for the whole component)"));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centroidY", "Centroid Y (pixels)", "Centroid Y (for the whole component)"));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centroidZ", "Centroid Z (pixels)", "Centroid Z (for the whole component)"));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centroidC", "Centroid C (pixels)", "Centroid Channel (for the whole component)"));
        VARIABLES.add(new JIPipeExpressionParameterVariableInfo("centroidT", "Centroid T (pixels)", "Centroid Frame (for the whole component)"));
