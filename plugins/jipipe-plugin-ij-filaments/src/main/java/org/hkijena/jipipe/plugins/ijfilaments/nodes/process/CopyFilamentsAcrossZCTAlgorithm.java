...
public class CopyFilamentsAcrossZCTAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    private JIPipeExpressionParameter channelRange = new JIPipeExpressionParameter("channelRange");
    private JIPipeExpressionParameter frameRange = new JIPipeExpressionParameter("frameRange");
    private JIPipeExpressionParameter zRange = new JIPipeExpressionParameter("zRange");
