...
@SetJIPipeDocumentation(name = "IJ3D Fast 3D median filter", description = "Calculates the local 3D median in an ellipsoidal neighbourhood.")
...
public class Fast3DFiltersMedianAlgorithm extends Fast3DFiltersAlgorithm {
    public Fast3DFiltersMedianAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public Fast3DFiltersMedianAlgorithm(Fast3DFiltersAlgorithm other) {
        super(other);
    }
