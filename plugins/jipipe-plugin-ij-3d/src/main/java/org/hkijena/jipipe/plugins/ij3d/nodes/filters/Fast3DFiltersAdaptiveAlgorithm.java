...
@SetJIPipeDocumentation(name = "IJ3D Fast 3D adaptive smoothing filter", description = "Applies the 3D adaptive smoothing filter (similar to the Nagao filter) using an ellipsoidal neighbourhood.")
