...
public class Roi3dListCellRenderer extends JPanel implements ListCellRenderer<Ij3dSuiteRoi> {
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends Ij3dSuiteRoi> list, Ij3dSuiteRoi value, int index, boolean isSelected, boolean cellHasFocus) {
