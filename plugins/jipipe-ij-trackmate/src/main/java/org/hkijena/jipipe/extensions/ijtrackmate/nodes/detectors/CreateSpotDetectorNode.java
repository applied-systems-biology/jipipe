...
public class CreateSpotDetectorNode extends JIPipeSimpleIteratingAlgorithm {
    ...
    @JIPipeParameter(value = "spot-detector-parameters", resourceClass = TrackMatePlugin.class, iconURL = "/org/hkijena/jipipe/extensions/ijtrackmate/icons/trackmate.png")
