...
public class Cellpose3PluginApplicationSettings extends JIPipeDefaultApplicationsSettingsSheet {
    ...
    public static String ID = "org.hkijena.jipipe:cellpose3";
    ...
    public Cellpose3PluginApplicationSettings() {
    ...
    public static Cellpose3PluginApplicationSettings getInstance() {
        return JIPipe.getSettings().getById(ID, Cellpose3PluginApplicationSettings.class);
    }
    ...
    public static void checkPythonSettings(JIPipeValidationReportContext context, JIPipeValidationReport report) {
        if (!pythonSettingsAreValid()) {
            report.add(new JIPipeValidationReportEntry(JIPipeValidationReportEntryLevel.Error,
                    ...
                    "This node requires an installation of Python with Cellpose 3.x. You have to point JIPipe to a Cellpose installation.",
    ...
    private void preconfigureEnvironment(PythonEnvironment environment) {
        ...
        environment.setArtifactQuery(new JIPipeArtifactQueryParameter("com.github.mouseland.cellpose3:*"));
    }
    ...
    @SetJIPipeDocumentation(name = "Default Cellpose 3.x environment", description = "The default Cellpose 3.x environment that is associated to newly created projects. " +
            "Leave at default (<code>com.github.mouseland.cellpose3:*</code>) to automatically select the best available environment from an artifact. " +
            "If disabled, falls back to <code>com.github.mouseland.cellpose3:*</code>.")
    ...
    public String getDescription() {
        return "Settings related to the Cellpose 3.x integration";
    }
}
