...
public class Cellpose3SegmentationTrainingTweaksSettings extends AbstractJIPipeParameterCollection {
    ...
    public Cellpose3SegmentationTrainingTweaksSettings() {
    }

    public Cellpose3SegmentationTrainingTweaksSettings(Cellpose3SegmentationTrainingTweaksSettings other) {
