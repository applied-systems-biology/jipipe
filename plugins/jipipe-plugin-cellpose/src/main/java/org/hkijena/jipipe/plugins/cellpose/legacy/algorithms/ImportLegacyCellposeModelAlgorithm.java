...
public class ImportLegacyCellposeModelAlgorithm extends JIPipeSimpleIteratingAlgorithm {
    public ImportLegacyCellposeModelAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public ImportLegacyCellposeModelAlgorithm(ImportLegacyCellposeModelAlgorithm other) {
        super(other);
    }
    ...
    protected void runIteration(JIPipeSingleIterationStep iterationStep, JIPipeIterationContext iterationContext, JIPipeGraphNodeRunContext runContext, JIPipeProgressInfo progressInfo) {
        ...
        iterationStep.addOutputData(getFirstOutputSlot(), new LegacyCellposeModelData(fileData.toPath()), progressInfo);
    }
}
