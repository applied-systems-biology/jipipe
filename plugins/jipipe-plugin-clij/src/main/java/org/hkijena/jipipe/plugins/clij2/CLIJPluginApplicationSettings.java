 ...
 * Settings for CLIJ
 */
public class CLIJPluginApplicationSettings extends JIPipeDefaultApplicationsSettingsSheet {
    ...
    public CLIJPluginApplicationSettings() {
    }

    public static CLIJPluginApplicationSettings getInstance() {
        return JIPipe.getSettings().getById(ID, CLIJPluginApplicationSettings.class);
    }
    ...
    public String getDescription() {
        return "Configure the GPU devices and how data is interchanged between ImageJ and CLIJ";
    }
