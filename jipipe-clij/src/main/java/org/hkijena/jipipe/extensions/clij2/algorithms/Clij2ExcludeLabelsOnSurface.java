...
public class Clij2ExcludeLabelsOnSurface extends JIPipeIteratingAlgorithm {
     ...
     */
    public Clij2ExcludeLabelsOnSurface(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
     ...
     */
    public Clij2ExcludeLabelsOnSurface(Clij2ExcludeLabelsOnSurface other) {
        super(other);
    ...
    protected void runIteration(JIPipeDataBatch dataInterface, JIPipeRunnerSubStatus subProgress, Consumer<JIPipeRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        ExcludeLabelsOnSurface.excludeLabelsOnSurface(clij2, pointlist, label_map_in, label_map_out, centerX, centerY, centerZ);
