...
@AlgorithmInputSlot(value = CLIJImageData.class, slotName = "buffer2", autoCreate = true)
@AlgorithmOutputSlot(value = CLIJImageData.class, slotName = "result", autoCreate = true)
...
public class Clij2AbsoluteDifference extends JIPipeIteratingAlgorithm {
     ...
     */
    public Clij2AbsoluteDifference(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
