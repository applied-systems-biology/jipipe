...
@AlgorithmInputSlot(value = CLIJImageData.class, slotName = "flaglist", autoCreate = true)
...
public class Clij2ExcludeLabels extends JIPipeIteratingAlgorithm {
     ...
     */
    public Clij2ExcludeLabels(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
    ...
    protected void runIteration(JIPipeDataBatch dataInterface, JIPipeRunnerSubStatus subProgress, Consumer<JIPipeRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        ClearCLBuffer flaglist = dataInterface.getInputData(getInputSlot("flaglist"), CLIJImageData.class).getImage();
