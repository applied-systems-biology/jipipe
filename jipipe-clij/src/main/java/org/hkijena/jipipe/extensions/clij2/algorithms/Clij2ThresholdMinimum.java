 ...
 */
@JIPipeDocumentation(name = "CLIJ2 Threshold Minimum", description = "The automatic thresholder utilizes the Minimum threshold method implemented in ImageJ using a histogram determined on " + "the GPU to create binary images as similar as possible to ImageJ 'Apply Threshold' method. Works for following image dimensions: 2D, 3D. Developed by Robert Haase based on work by G. Landini and W. Rasband. Licensed under The code for the automatic thresholding methods originates from https://github.com/imagej/imagej1/blob/master/ij/process/AutoThresholder.java" + "Detailed documentation on the implemented methods can be found online: https://imagej.net/Auto_Threshold")
...
public class Clij2ThresholdMinimum extends JIPipeSimpleIteratingAlgorithm {
     ...
     */
    public Clij2ThresholdMinimum(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
