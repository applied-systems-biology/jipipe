...
public class Clij2AverageDistanceOfTouchingNeighbors extends JIPipeIteratingAlgorithm {
     ...
     */
    public Clij2AverageDistanceOfTouchingNeighbors(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
    ...
    protected void runIteration(JIPipeDataBatch dataInterface, JIPipeRunnerSubStatus subProgress, Consumer<JIPipeRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        dataInterface.addOutputData(getOutputSlot("average_distancelist_destination"), new CLIJImageData(average_distancelist_destination));
    }
