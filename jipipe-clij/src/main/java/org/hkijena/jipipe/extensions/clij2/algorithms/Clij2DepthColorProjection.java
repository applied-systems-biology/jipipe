...
@AlgorithmInputSlot(value = CLIJImageData.class, slotName = "lut", autoCreate = true)
@AlgorithmOutputSlot(value = CLIJImageData.class, slotName = "dst_depth", autoCreate = true)
