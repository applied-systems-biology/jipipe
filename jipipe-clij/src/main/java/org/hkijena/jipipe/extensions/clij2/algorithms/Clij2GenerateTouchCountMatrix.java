...
@AlgorithmOutputSlot(value = CLIJImageData.class, slotName = "dst_touch_count_matrix", autoCreate = true)
...
public class Clij2GenerateTouchCountMatrix extends JIPipeSimpleIteratingAlgorithm {
     ...
     */
    public Clij2GenerateTouchCountMatrix(JIPipeAlgorithmDeclaration declaration) {
        super(declaration);
    }
    ...
    protected void runIteration(JIPipeDataBatch dataInterface, JIPipeRunnerSubStatus subProgress, Consumer<JIPipeRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        dataInterface.addOutputData(getOutputSlot("dst_touch_count_matrix"), new CLIJImageData(dst_touch_count_matrix));
    }
