...
@JIPipeDocumentation(name = "Table to histogram", description = "Given a table with two numeric columns containing a key and a value, integrate all values assigned to a key into a single value. Allows the generation of normalized and cumulative histograms.")
