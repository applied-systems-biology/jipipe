...
import org.hkijena.jipipe.extensions.annotation.AnnotationsPlugin;
...
import org.hkijena.jipipe.extensions.tables.nodes.rows.ApplyExpressionPerRowAlgorithm2;
...
import org.hkijena.jipipe.extensions.tables.nodes.transform.ApplyExpressionPerLabelAlgorithm;
import org.hkijena.jipipe.extensions.tables.nodes.transform.MeltTableAlgorithm;
import org.hkijena.jipipe.extensions.tables.nodes.transform.TableToHistogramAlgorithm;
...
public class TablesPlugin extends JIPipePrepackagedDefaultJavaPlugin {
    ...
    public static final JIPipeResourceManager RESOURCES = new JIPipeResourceManager(TablesPlugin.class, "org/hkijena/jipipe/extensions/tables");
