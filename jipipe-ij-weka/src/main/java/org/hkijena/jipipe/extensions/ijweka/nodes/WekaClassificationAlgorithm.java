...
@JIPipeDocumentation(name = "Weka classifier", description = "Classifies an image with a Weka model")
...
public class WekaClassificationAlgorithm extends JIPipeIteratingAlgorithm {
    public WekaClassificationAlgorithm(JIPipeNodeInfo info) {
        super(info);
    }

    public WekaClassificationAlgorithm(WekaClassificationAlgorithm other) {
        super(other);
    }
