...
public class HelpCommand {
    public static void showHelp() {
        ...
        System.out.println();
        System.out.println("create-ro-crate <options>");
        System.out.println("    Creates an RO-Crate from a JIPipe project file.");
        System.out.println("    --project <Project file>                                                       Sets the project file");
        System.out.println("    --output <Output ZIP file>                                                     Sets the output RO-Crate ZIP file");
        System.out.println();
        System.out.println("    Optional parameters:");
        System.out.println("    --U<User path key> <User path value>                                           Overrides one user path key with the specified path");
        System.out.println();
