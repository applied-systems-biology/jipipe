 ...
 */
@ACAQDocumentation(name = "Sort and extract ROI by statistics (unreferenced)", description = "Sorts the ROI list elements via statistics and allows to you extract the n top values. This algorithm does not require a " +
...
public class UnreferencedSortAndExtractRoiByStatisticsAlgorithm extends ACAQSimpleIteratingAlgorithm {
     ...
     */
    public UnreferencedSortAndExtractRoiByStatisticsAlgorithm(ACAQAlgorithmDeclaration declaration) {
     ...
     */
    public UnreferencedSortAndExtractRoiByStatisticsAlgorithm(UnreferencedSortAndExtractRoiByStatisticsAlgorithm other) {
        super(other);
