 ...
 */
@ACAQDocumentation(name = "Filter ROI by statistics (unreferenced)", description = "Filters the ROI list elements via statistics. This algorithm does not require a " +
...
public class UnreferencedFilterRoiByStatisticsAlgorithm extends ACAQSimpleIteratingAlgorithm {
     ...
     */
    public UnreferencedFilterRoiByStatisticsAlgorithm(ACAQAlgorithmDeclaration declaration) {
     ...
     */
    public UnreferencedFilterRoiByStatisticsAlgorithm(UnreferencedFilterRoiByStatisticsAlgorithm other) {
        super(other);
    ...
    protected void runIteration(ACAQDataInterface dataInterface, ACAQRunnerSubStatus subProgress, Consumer<ACAQRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        roiStatisticsAlgorithm.getFirstInputSlot().addData(inputData);
