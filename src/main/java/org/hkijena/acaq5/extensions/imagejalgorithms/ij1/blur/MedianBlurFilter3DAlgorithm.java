 ...
 */
@ACAQDocumentation(name = "Median blur 3D", description = "Applies convolution with a local median function in 3D space for smoothing. " +
...
public class MedianBlurFilter3DAlgorithm extends ACAQSimpleIteratingAlgorithm {
     ...
     */
    public MedianBlurFilter3DAlgorithm(ACAQAlgorithmDeclaration declaration) {
