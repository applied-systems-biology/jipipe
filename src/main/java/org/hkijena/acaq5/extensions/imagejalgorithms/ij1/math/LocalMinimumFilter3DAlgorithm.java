 ...
 */
@ACAQDocumentation(name = "Local minimum 3D", description = "Calculates the local minimum around each pixel. This is also referred as greyscale erosion. " +
...
public class LocalMinimumFilter3DAlgorithm extends ACAQSimpleIteratingAlgorithm {
     ...
     */
    public LocalMinimumFilter3DAlgorithm(ACAQAlgorithmDeclaration declaration) {
