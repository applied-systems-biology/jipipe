 ...
 */
@ACAQDocumentation(name = "Box filter 2D (3x3)", description = "Applies a 3x3 smoothing filter. " +
        "If higher-dimensional data is provided, the filter is applied to each 2D slice.")
@ACAQOrganization(menuPath = "Blur")
...
public class BoxFilter2DAlgorithm extends ImageJ1Algorithm {
     ...
     */
    public BoxFilter2DAlgorithm(ACAQAlgorithmDeclaration declaration) {
