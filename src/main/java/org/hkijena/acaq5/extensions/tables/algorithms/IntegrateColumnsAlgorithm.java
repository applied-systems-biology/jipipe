 ...
 */
@ACAQDocumentation(name = "Integrate table columns", description = "Integrates table columns by applying operations like average, standard deviation, mor median")
...
public class IntegrateColumnsAlgorithm extends ACAQSimpleIteratingAlgorithm {
    ...
    protected void runIteration(ACAQDataInterface dataInterface, ACAQRunnerSubStatus subProgress, Consumer<ACAQRunnerSubStatus> algorithmProgress, Supplier<Boolean> isCancelled) {
        ...
        for (IntegratingTableColumnProcessorParameter processor : processorParameters) {
            ...
            TableColumn sourceColumnData = input.getColumn(input.getColumnIndex(sourceColumn));
