...
import org.hkijena.acaq5.extensions.parameters.collections.StringRenamingCollection;
...
public class RenameColumnAlgorithm extends ACAQIteratingAlgorithm {
    ...
    private StringRenamingCollection renamingEntries = new StringRenamingCollection();
    ...
    public RenameColumnAlgorithm(RenameColumnAlgorithm other) {
        super(other);
        this.renamingEntries = new StringRenamingCollection(renamingEntries);
    }
    ...
    public void reportValidity(ACAQValidityReport report) {
        ...
        for (int i = 0; i < renamingEntries.size(); i++) {
            if (StringUtils.isNullOrEmpty(renamingEntries.get(i).getTarget())) {
    ...
    public StringRenamingCollection getRenamingEntries() {
        return renamingEntries;
    }

    @ACAQParameter("renaming-entries")
    public void setRenamingEntries(StringRenamingCollection renamingEntries) {
