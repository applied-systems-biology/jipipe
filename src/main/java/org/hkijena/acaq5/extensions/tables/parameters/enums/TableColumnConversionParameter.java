...
/**
 * Enum-like parameter that allows the selection of a {@link org.hkijena.acaq5.extensions.tables.operations.ConvertingColumnOperation}.
...
public class TableColumnConversionParameter extends DynamicEnumParameter {
    ...
    public TableColumnConversionParameter() {
        List<Object> allowedValues = new ArrayList<>(ACAQTableRegistry.getInstance().getOperationsOfType(ConvertingColumnOperation.class).values()
