 ...
 */
public class ACAQAlgorithmCacheBrowserUI extends ACAQProjectWorkbenchPanel {
    private final ACAQGraphNode graphNode;
    private JSplitPane splitPane;
    private ACAQAlgorithmCacheTree tree;

    /**
     * @param workbenchUI the workbench
     * @param graphNode   the node
     */
    public ACAQAlgorithmCacheBrowserUI(ACAQProjectWorkbench workbenchUI, ACAQGraphNode graphNode) {
        super(workbenchUI);
    ...
    private void initialize() {
        ...
        tree = new ACAQAlgorithmCacheTree(getProjectWorkbench(), graphNode);
    ...
    public ACAQAlgorithmCacheTree getTree() {
        return tree;
    }
