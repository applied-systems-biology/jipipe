...
public class ACAQAlgorithmParametersUI extends ACAQParameterAccessUI {
    ...
    public ACAQAlgorithmParametersUI(ACAQAlgorithm algorithm, MarkdownDocument documentation, boolean documentationBelow, boolean withDocumentation) {
        super(algorithm, documentation, documentationBelow, withDocumentation);
