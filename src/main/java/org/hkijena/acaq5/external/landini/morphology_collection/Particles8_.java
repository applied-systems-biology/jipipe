...
// 2.13  25/Jul/2012 allow to be called without showing the image
...
public class Particles8_ implements PlugIn {
	...
	public void run(String arg) {
		...
		if (wList==null || wList.length<1) {
			IJ.showMessage("Particles8 ","There must be at least one image open");
			return;
		}
		...
		gd.addMessage("Particles8_ v2.19 by G. Landini");
