...
public abstract class SpotSegmentation3DAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    protected void runIteration(JIPipeDataBatch dataBatch, JIPipeProgressInfo progressInfo) {
        ...
        ROI3DListData outputRoi = new ROI3DListData();
    ...
    @JIPipeDocumentation(name = "Seeds threshold", description = "Local threshold that is applied around each seed")
    ...
    public static class SeedSegmentationSettings extends AbstractJIPipeParameterCollection {
