...
import org.hkijena.jipipe.contrib.ro_crate.reader.GenericReaderStrategy;
...
public class LearnByExampleTest {
     ...
     * Check the module {@link org.hkijena.jipipe.contrib.ro_crate.externalproviders} for
    ...
    void writingAndReadingStrategies(@TempDir Path tempDir) throws IOException {
        ...
        RoCrate read = new CrateReader<>(
                ...
                new org.hkijena.jipipe.contrib.ro_crate.reader.ReadFolderStrategy()
        )
                .readCrate(folder.toAbsolutePath().toString());
