...
@JIPipeDocumentation(name = "Convert color image to HSB colors", description = "Converts an image into an HSB image or re-interprets existing image channels as HSB. " +
