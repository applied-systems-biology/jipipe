...
public class ImagePlus3DGreyscaleData extends ImagePlus3DData {
    ...
    public ImagePlus3DGreyscaleData(ImageSource source) {
    ...
    public ImagePlus3DGreyscaleData(ImageSource source, ColorSpace colorSpace) {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus3DGreyscaleData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        if (data.hasLoadedImage()) {
            ...
            return new ImagePlus3DGreyscaleData(data.getImageSource());
        }
    }
}
