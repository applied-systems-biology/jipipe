 ...
 */
public class OMEImageDataSlotRowUI extends JIPipeDefaultResultDataSlotRowUI {
     ...
     */
    public OMEImageDataSlotRowUI(JIPipeProjectWorkbench workbenchUI, JIPipeDataSlot slot, JIPipeExportedDataTable.Row row) {
    ...
    private void loadImage() {
        OMEImageData data = new OMEImageData(getRowStorageFolder());
