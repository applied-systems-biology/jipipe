...
@JIPipeHeavyData
public class ImagePlus4DColorRGBData extends ImagePlus4DColorData implements ColoredImagePlusData {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus4DColorRGBData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
