 ...
 * this should not be outside the control of JIPipe to prevent issues.
 * Those measurements are also used by {@link ij.plugin.frame.RoiManager}.
 */
public class ImageStatisticsParameters implements JIPipeParameterCollection {
    ...
    @JIPipeDocumentation(name = "Measure area",
    ...
    @JIPipeDocumentation(name = "Measure pixel values standard deviation",
            description = "Measures the standard deviation of greyscale pixel values. They are stored as 'StdDev'.")
    @JIPipeParameter("measure-pixel-stdev")
    ...
    @JIPipeDocumentation(name = "Measure center of mass",
    ...
    @JIPipeParameter("measure-center-of-mass")
    ...
    @JIPipeDocumentation(name = "Measure bounding rectangle",
    ...
    @JIPipeParameter("measure-bounding-rectangle")
    ...
    @JIPipeDocumentation(name = "Measure shape descriptors",
    ...
    @JIPipeParameter("measure-shape-descriptors")
    ...
    @JIPipeDocumentation(name = "Measure integrated density",
    ...
    @JIPipeParameter("measure-integrated-density")
    ...
    @JIPipeDocumentation(name = "Measure area fraction",
            description = "The percentage of non-zero pixels. Values are stored in '%Area'")
    @JIPipeParameter("measure-area-fraction")
    ...
    @JIPipeDocumentation(name = "Measure pixel values mean",
            description = "Mean of grayscale pixel values. Values are stored in 'Mean'.")
    @JIPipeParameter("measure-pixel-mean")
    ...
    @JIPipeDocumentation(name = "Measure centroid",
    ...
    @JIPipeParameter("measure-centroid")
    ...
    @JIPipeDocumentation(name = "Fit ellipse",
    ...
    @JIPipeDocumentation(name = "Measure Feret's diameter",
    ...
    @JIPipeDocumentation(name = "Output stack position",
    ...
    @JIPipeParameter("output-stack-position")
