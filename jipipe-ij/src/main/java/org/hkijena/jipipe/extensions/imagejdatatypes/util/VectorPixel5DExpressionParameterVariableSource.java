 ...
 */
public class VectorPixel5DExpressionParameterVariableSource implements ExpressionParameterVariableSource {
    ...
    static {
        ...
        VARIABLES.add(new ExpressionParameterVariable("Vector", "An array of greyscale values", "vector"));
