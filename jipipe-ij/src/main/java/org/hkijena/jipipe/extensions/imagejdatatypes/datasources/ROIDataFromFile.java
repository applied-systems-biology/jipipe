 ...
 */
@JIPipeDocumentation(name = "ROI from file", description = "Loads a ROI list from a file. The file can be either a single ROI (.roi extension) or a list of ROI (.zip extension).")
