...
public class ROIDataPreview extends JIPipeAsyncResultDataPlotPreview {
     ...
     * @param row       the row
     */
    public ROIDataPreview(JIPipeProjectWorkbench workbench, JTable table, JIPipeDataSlot slot, JIPipeExportedDataTable.Row row) {
