...
public class ImagePlus2DGreyscaleMaskData extends ImagePlus2DGreyscale8UData {
    ...
    public ImagePlus2DGreyscaleMaskData(ImageSource source) {
    ...
    public ImagePlus2DGreyscaleMaskData(ImageSource source, ColorSpace colorSpace) {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus2DGreyscaleMaskData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        if (data.hasLoadedImage()) {
            ...
            return new ImagePlus2DGreyscaleMaskData(data.getImageSource());
        }
    }
}
