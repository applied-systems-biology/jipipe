...
@JIPipeHeavyData
public class ImagePlus4DColorHSBData extends ImagePlus4DColorData implements ColoredImagePlusData {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus4DColorHSBData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
