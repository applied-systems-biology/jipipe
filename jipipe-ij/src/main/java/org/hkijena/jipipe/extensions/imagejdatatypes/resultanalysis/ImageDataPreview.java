...
public class ImageDataPreview extends JIPipeAsyncResultDataPlotPreview {
     ...
     */
    public ImageDataPreview(JIPipeProjectWorkbench workbench, JTable table, JIPipeDataSlot slot, JIPipeExportedDataTableRow row, JIPipeExportedDataAnnotation dataAnnotation) {
