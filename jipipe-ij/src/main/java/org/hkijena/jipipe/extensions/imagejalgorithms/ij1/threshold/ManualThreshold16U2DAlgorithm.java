...
public class ManualThreshold16U2DAlgorithm extends JIPipeSimpleIteratingAlgorithm {
     ...
     */
    public ManualThreshold16U2DAlgorithm(JIPipeAlgorithmDeclaration declaration) {
        super(declaration, JIPipeDefaultMutableSlotConfiguration.builder().addInputSlot("Input", ImagePlusGreyscale16UData.class)
    ...
    @JIPipeDocumentation(name = "Threshold", description = "All pixel values less or equal to this are set to zero. The value interval is [0, " + 2 * Short.MAX_VALUE + "]")
