 ...
 */
public class LocalPixelCoordinate5DExpressionParameterVariableSource implements ExpressionParameterVariableSource {
    ...
    static {
        ...
        VARIABLES.add(new ExpressionParameterVariable("Local area width", "The width of the local area window", "lw"));
        VARIABLES.add(new ExpressionParameterVariable("Local area height", "The height of the local area window", "lh"));
