 ...
 */
@JIPipeDocumentation(name = "2D image (8 bit)", description = "An 8-bit greyscale image")
...
public class ImagePlus2DGreyscale8UData extends ImagePlus2DGreyscaleData {
    ...
    public ImagePlus2DGreyscale8UData(ImageSource source) {
     ...
     */
    public ImagePlus2DGreyscale8UData(ImageDimensions dimensions) {
    ...
    public ImagePlus2DGreyscale8UData(ImagePlus image, ColorSpace colorSpace) {
        super(ImageJUtils.convertToGreyscale8UIfNeeded(image), colorSpace);
    }

    public ImagePlus2DGreyscale8UData(ImageSource source, ColorSpace colorSpace) {
        super(new ConverterWrapperImageSource(source, ImageJUtils::convertToGreyscale8UIfNeeded), colorSpace);
    }

    public static ImagePlusData importData(JIPipeReadDataStorage storage, JIPipeProgressInfo progressInfo) {
        return new ImagePlus2DGreyscale8UData(ImagePlusData.importImagePlusFrom(storage, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        if (data.hasLoadedImage()) {
            return new ImagePlus2DGreyscale8UData(data.getImage());
        } else {
            return new ImagePlus2DGreyscale8UData(data.getImageSource());
        }
    }
}
