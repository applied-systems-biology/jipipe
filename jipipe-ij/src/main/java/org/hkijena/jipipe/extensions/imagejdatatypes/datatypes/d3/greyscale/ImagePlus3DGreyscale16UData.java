 ...
 */
@JIPipeDocumentation(name = "3D image (16 bit)")
...
public class ImagePlus3DGreyscale16UData extends ImagePlus3DGreyscaleData {
    ...
    public ImagePlus3DGreyscale16UData(ImageSource source) {
    ...
    public ImagePlus3DGreyscale16UData(ImageSource source, ColorSpace colorSpace) {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus3DGreyscale16UData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        if (data.hasLoadedImage()) {
            ...
            return new ImagePlus3DGreyscale16UData(data.getImageSource());
        }
    }
}
