...
public class ImagePlus3DGreyscale8UData extends ImagePlus3DGreyscaleData {
    ...
    public ImagePlus3DGreyscale8UData(ImageSource source) {
    ...
    public ImagePlus3DGreyscale8UData(ImageSource source, ColorSpace colorSpace) {
    ...
    public static ImagePlusData importFrom(Path storageFolder, JIPipeProgressInfo progressInfo) {
        return new ImagePlus3DGreyscale8UData(ImagePlusData.importImagePlusFrom(storageFolder, progressInfo));
    }
    ...
    public static ImagePlusData convertFrom(ImagePlusData data) {
        if (data.hasLoadedImage()) {
            ...
            return new ImagePlus3DGreyscale8UData(data.getImageSource());
        }
    }
}
