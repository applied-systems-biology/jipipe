...
public class GrayscaleAttributeFiltering2DAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    protected void runIteration(JIPipeSingleDataBatch dataBatch, JIPipeProgressInfo progressInfo) {
        ImagePlus inputImg = dataBatch.getInputData(getFirstInputSlot(), ImagePlusGreyscaleData.class, progressInfo).getImage();
        ...
        dataBatch.addOutputData(getFirstOutputSlot(), new ImagePlusGreyscaleData(outputImg), progressInfo);
    }
