...
public class TransformSetDimensionsAlgorithm extends JIPipeIteratingAlgorithm {
    ...
    public TransformSetDimensionsAlgorithm(JIPipeNodeInfo info) {
        super(info);
        scale2DAlgorithm = JIPipe.createNode(TransformScale2DAlgorithm.class);
        registerSubParameter(scale2DAlgorithm);
    }

    public TransformSetDimensionsAlgorithm(TransformSetDimensionsAlgorithm other) {
        super(other);
