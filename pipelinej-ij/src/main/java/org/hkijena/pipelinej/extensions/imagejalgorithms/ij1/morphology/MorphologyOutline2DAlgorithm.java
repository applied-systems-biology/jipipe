...
public class MorphologyOutline2DAlgorithm extends ACAQSimpleIteratingAlgorithm {
     ...
     */
    public MorphologyOutline2DAlgorithm(ACAQAlgorithmDeclaration declaration) {
