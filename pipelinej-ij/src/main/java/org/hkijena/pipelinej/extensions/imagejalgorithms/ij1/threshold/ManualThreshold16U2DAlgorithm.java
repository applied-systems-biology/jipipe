...
package org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.threshold;
...
import static org.hkijena.pipelinej.extensions.imagejalgorithms.ImageJAlgorithmsExtension.ADD_MASK_QUALIFIER;
...
public class ManualThreshold16U2DAlgorithm extends ACAQSimpleIteratingAlgorithm {
    ...
    public ManualThreshold16U2DAlgorithm(ACAQAlgorithmDeclaration declaration) {
        super(declaration, ACAQDefaultMutableSlotConfiguration.builder().addInputSlot("Input", ImagePlusGreyscale16UData.class)
