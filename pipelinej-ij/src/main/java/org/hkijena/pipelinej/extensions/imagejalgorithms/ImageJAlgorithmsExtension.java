...
package org.hkijena.pipelinej.extensions.imagejalgorithms;
...
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.EigenvalueSelection2D;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.InterpolationMethod;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.MacroWrapperAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.analyze.FindParticles2D;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.background.RollingBallBackgroundEstimator2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.binary.DistanceTransformWatershed2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.binary.UltimateErodedPoints2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.binary.Voronoi2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.blur.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.color.ArrangeChannelsAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.color.InvertColorsAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.color.MergeChannelsAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.color.SplitChannelsAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.contrast.CLAHEContrastEnhancer;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.contrast.IlluminationCorrection2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.convolve.Convolve2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.dimensions.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.edge.SobelEdgeDetectorAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.features.FrangiVesselnessFeatures;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.features.LocalMaxima2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.features.MeijeringVesselness2DFeatures;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.fft.FFT2DForwardTransform;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.fft.FFT2DInverseTransform;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.fft.FFT2DSwapQuadrants;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.math.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.measure.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.morphology.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.noise.AddNoise2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.noise.DespeckleFilter2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.noise.RemoveOutliersFilter2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.roi.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.sharpen.LaplacianSharpen2DAlgorithm;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.statistics.GreyscalePixelsGenerator;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.statistics.HistogramGenerator;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.threshold.*;
import org.hkijena.pipelinej.extensions.imagejalgorithms.ij1.transform.*;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.ImagePlusData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.color.ImagePlusColor8UData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.color.ImagePlusColorData;
...
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d2.color.ImagePlus2DColor8UData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d2.color.ImagePlus2DColorData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d2.color.ImagePlus2DColorRGBData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d2.greyscale.*;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d3.ImagePlus3DData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d3.color.ImagePlus3DColor8UData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d3.color.ImagePlus3DColorData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d3.color.ImagePlus3DColorRGBData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d3.greyscale.*;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d4.ImagePlus4DData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d4.color.ImagePlus4DColor8UData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d4.color.ImagePlus4DColorData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d4.color.ImagePlus4DColorRGBData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d4.greyscale.*;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d5.ImagePlus5DData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d5.color.ImagePlus5DColor8UData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d5.color.ImagePlus5DColorData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d5.color.ImagePlus5DColorRGBData;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.d5.greyscale.*;
import org.hkijena.pipelinej.extensions.imagejdatatypes.datatypes.greyscale.*;
